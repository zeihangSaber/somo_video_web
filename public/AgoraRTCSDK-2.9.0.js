							...
							setTimeout(function() {
								!(function(e, t, n) {
									...
									function() {
										(p = 0),
											0 !== u.length
												? ((l = u.length < 10 ? u.splice(0, u.length) : u.splice(0, 10)), e(l))
												: (d = "free");
									},
									function() {
										setTimeout(
					...
					}),
					{
						...
						setProxyServer: function(e) {
							g = e
								? "https://"
										.concat(e, "/ls/?h=")
										.concat(Object(o.getParameter)("LOG_UPLOAD_SERVER"), "&p=443&d=upload/v1")
								: "https://".concat(Object(o.getParameter)("LOG_UPLOAD_SERVER"), "/upload/v1");
						},
									...
									if (Object(o.getParameter)("UPLOAD_LOG"))
										try {
											...
											t.forEach(function(e) {
												...
												"free" === d &&
													((l = u.length < 10 ? u.splice(0, u.length) : u.splice(0, 10)),
													I(l));
										} catch (e) {}
								})(t, n),
								!(t < S))
		...
		function(e, t, n) {
			...
			var p = {
				...
				g = (function() {
					var e = { list: {} };
					(e.url = Object(d.e)()
						? "https://".concat(Object(s.getParameter)("EVENT_REPORT_DOMAIN"), ":6443/events/message")
						: "http://".concat(Object(s.getParameter)("EVENT_REPORT_DOMAIN"), ":6080/events/message")),
						(e.urlBackup = Object(d.e)()
							? "https://".concat(
						...
						(e.setProxyServer = function(t) {
							t
								? ((e.url = Object(d.e)()
								  ...
								  c.default.debug("reportProxyServerBackupURL: ".concat(e.urlBackup)))
								: ((e.url = Object(d.e)()
										? "https://".concat(
												Object(s.getParameter)("EVENT_REPORT_DOMAIN"),
												":6443/events/message"
					...
					return (
						(e.reportApiInvoke = function(e, n) {
							...
							return function(e, t) {
								if ((clearTimeout(y), ++S > 1 && (e = "EXECUTOR_INVOKE_".concat(S)), e))
									return (
										g._sendApiInvoke(a()({}, h(), { success: !1, error: e }, o && { states: o() })),
										_ && c.default.info("".concat(r, " onFailure"), e),
										p && p(e)
									);
								g._sendApiInvoke(
									a()({}, h(), { success: !0 }, m && { result: t }, o && { states: o() })
								),
									_ && c.default.info("".concat(r, " onSuccess")),
									p && p(null, t);
							};
						}),
						(e._cachedItems = []),
						...
						(e._send = function(t) {
							try {
								...
								t && t.data && t.data.apiName
									...
									: t && t.data && t.data.eventType && n.push(["eventType", t.data.eventType]);
								var i = n
										.map(function(e) {
									...
									function(n) {
										var a =
											-1 === e.urlBackup.indexOf("?")
												...
												: e.urlBackup;
										Object(d.c)(a, t, null, function(e) {}, { timeout: 1e4 });
									},
									{ timeout: 1e4 }
								);
							} catch (e) {}
		...
		function(e, t, n) {
			...
			var i = n(2),
				...
				u = function(e, t, n, s, c) {
					...
					if (
						((d.timeout = t.timeout || Object(i.getParameter)("HTTP_CONNECT_TIMEOUT")),
						d.open("POST", e, !0),
			...
			var l = function(e, t, n) {
					try {
						...
						r.setAttribute("autoplay", ""),
							...
							r.setAttribute("style", "position: absolute; top: 0; left: 0; width:1px; high:1px;"),
								...
								i.isFireFox()
									? r.videoWidth &&
									  (a.default.debug(
											...
											"".concat(r.videoWidth, " x ").concat(r.videoHeight),
											e
									  ),
		...
		function(e, t, n) {
			...
			if (
				("object" == ("undefined" == typeof window ? "undefined" : a()(window))
					? (!window.HTMLMediaElement || "srcObject" in window.HTMLMediaElement.prototype
							? ((f = function(e, t) {
									e.srcObject = t;
							  }),
							  (m = function(e) {
							...
							: ((f = function(e, t) {
									"mozSrcObject" in e
										? (e.mozSrcObject = t)
										: ((e._srcObject = t), (e.src = t ? URL.createObjectURL(t) : null));
							  }),
							  (m = function(e) {
				...
				if (navigator.mozGetUserMedia && window.mozRTCPeerConnection) {
					for (var I in (S.log("This appears to be Firefox"),
					(d = "firefox"),
									...
									if (a.hasOwnProperty("urls"))
										for (var r = 0; r < a.urls.length; r++) {
											...
											0 === a.urls[r].indexOf("turn") &&
												((o.username = a.username), (o.credential = a.credential)),
												n.push(o);
										}
								...
								return (
									Object.keys(e).forEach(function(n) {
										if ("require" !== n && "advanced" !== n && "mediaSource" !== n) {
											...
											if (
												((void 0 === i.min && void 0 === i.max && void 0 === i.exact) ||
													t.push(n),
												void 0 !== i.exact &&
					...
					for (var I in (S.log("This appears to be Chrome"),
					(d = "chrome"),
							...
							Object.keys(e).forEach(function(n) {
								if ("require" !== n && "advanced" !== n && "mediaSource" !== n) {
									...
									void 0 !== i.exact && "number" != typeof i.exact
										? ((t.mandatory = t.mandatory || {}), (t.mandatory[r("", n)] = i.exact))
										: ["min", "max"].forEach(function(e) {
												void 0 !== i[e] &&
													((t.mandatory = t.mandatory || {}), (t.mandatory[r(e, n)] = i[e]));
										  });
								}
							}),
					...
					if (
						((o = function(e, t, n) {
							return (
								e.audio && (e.audio = _(e.audio)),
								e.video && (e.video = _(e.video)),
					...
					void 0 === navigator.mediaDevices.addEventListener &&
						...
						(s = function(e, t) {
							u >= 43
								...
								: S.log("Error attaching stream to element.");
						}),
						(c = function(e, t) {
					...
					navigator.mediaDevices && navigator.userAgent.match(/Edge\/(\d+).(\d+)$/)
						? (S.log("This appears to be Edge"),
						  (d = "edge"),
						  (u = S.extractVersion(navigator.userAgent, /Edge\/(\d+).(\d+)$/, 2)),
						  (l = 12))
						: S.log("Browser does not appear to be WebRTC-capable");
			...
			var o = (function() {
				...
				return (
					...
					(e.prototype.getStats = function(e, t) {
						if (
							(void 0 === t && (t = 500), (t = t > 500 ? 500 : t), Date.now() - this.lastTimeGetStats < t)
						) {
							var n = [];
							this.config.isSubscriber
								? (n.push(this.receiveVideoStats), n.push(this.receiveAudioStats))
							...
							(t.lastTimeGetStats = Date.now()),
								Object.keys(i).map(function(e) {
									...
									t.config.isSubscriber
										? n.type && "inboundrtp" === n.type && n.mediaType && "audio" === n.mediaType
											? ((t.receiveAudioStats.id = n.id + "recv"),
											  ...
											  (t.receiveAudioStats.googJitterReceived = n.jitter + ""))
											: n.type &&
											  "inboundrtp" === n.type &&
											  n.mediaType &&
											  "video" === n.mediaType
											...
											? ((t.receiveVideoStats.googFrameHeightReceived = n.frameHeight + ""),
											  ...
											  (t.receiveVideoStats.googFrameReceived = n.framesReceived + ""))
											: n.remoteSource &&
											  n.type &&
											  "track" === n.type &&
											  n.trackIdentifier &&
											  -1 !== n.trackIdentifier.indexOf("a") &&
											  (t.receiveAudioStats.audioOutputLevel = n.audioLevel + "")
										: !n.isRemote &&
										  n.type &&
										  "outboundrtp" === n.type &&
										  n.mediaType &&
										...
										: !n.remoteSource &&
										  ...
										  n.framesSent &&
										  0 !== n.framesSent &&
										  ((t.sendVideoStats.googFrameHeightSent = n.frameHeight + ""),
					...
					(e.prototype._oniceconnectionstatechange = function(e) {
						"connected" === e.currentTarget.iceConnectionState &&
							((this.state = i.ESTABLISHED), (this.connectedTime = Date.now())),
							this.oniceconnectionstatechange &&
								this.oniceconnectionstatechange(e.currentTarget.iceConnectionState);
					}),
						...
						if ((t = e.match(/m=video.*\r\n/)) && o && s) {
							...
							"h264" === r
								...
								-1 !== u &&
									-1 !== l &&
									l - u > 10 &&
									(n = n + "a=fmtp:" + e.slice(u + 9, l - 1) + " x-google-min-bitrate=" + o + "\r\n"),
								(e = e.replace(t[0], n)),
								a.default.debug("[" + d + "]Set Video Bitrate - min:" + o + " max:" + s);
						}
						return (
							(t = e.match(/m=audio.*\r\n/)) &&
								c &&
						...
						switch (a.label) {
							...
							case 1:
								try {
									...
									return (
										c.default.error("Failed to init RTCPeerConnection", e), [2, Promise.reject(e)]
									);
								}
								return n
									? [3, 2]
							...
							case 2:
								return e && e.stream
									...
									: ((i = {
									  ...
									  (r = void 0),
									  (s.isSafari() || s.isFireFox() || s.isWeChatBrowser()) && n.addTransceiver
		...
		function(e, t, n) {
			...
			var g = new (function() {
				...
				V = function(e) {
							...
							return a
								? a.setSinkId
									? void a
											...
											.catch(function(e) {
												return (
													r.default.error("[" + t.id + "] VideoPlayer.setAudioOutput", e),
													i && i(e)
												);
											})
									: (r.default.error("[" + t.id + "] ", x.WEB_API_NOT_SUPPORTED),
									  i && i(x.WEB_API_NOT_SUPPORTED))
								: (r.default.error("[" + t.id + "] ", x.PLAYER_NOT_FOUND), i && i(x.PLAYER_NOT_FOUND));
						}),
						(t.destroy = function() {
							r.default.debug(
								"destroy ".concat(e.stream.local ? "local" : "remote", " Player ").concat(t.id)
							),
								...
								["video", "audio"].forEach(function(n) {
									...
									r.default.debug("Media Player Status Change Triggered by destroy()", c),
										e.stream.dispatchEvent(c),
										o.b.reportApiInvoke(e.stream.sid, {
					...
					var n = {
							...
							muted:
								!!e.stream.local ||
								(!(!f.isSafari() && "iOS" !== f.getBrowserOS()) && "video_element_muted"),
							playsinline: !0,
					...
					t.mediaElemExists = function(e) {
						for (var t = e, n = 0; n < Object(a.getParameter)("MEDIA_ELEMENT_EXISTS_DEPTH") && t; n++)
							t = t.parentNode;
						return !!t;
					};
					var c = function(e) {
						...
						d = function(e, t, n) {
							...
							return (
								"paused" === i
									? ("audio" === t && !0 === n.muted && (a = !1), n.autoplay || (a = !1))
									: "play" === i
									? "video" === t
										? (a = !1)
										: !0 === n.muted
									...
									(s[u].playDeferTimeout = setTimeout(function() {
										...
										if (p === f) {
											...
											if (a.status !== m.status) {
												...
												r.default.debug("Media Player Status Change", g),
											...
											r.default.debug(
												"Status Change after event Triggered." +
													"Stream "
														.concat(t.id, " PlayerId ")
					...
					if (
							...
							["video", "audio"].forEach(function(n) {
								...
								if (!u.playDeferTimeout) {
									...
									if (u.status !== l.status) {
										...
										r.default.debug("Media Player Status Change", p),
						...
						t.div.appendChild(t.video),
							...
							f.isEdge()
								...
								: (Object(h.attachMediaStream)(t.video, e.stream.stream),
								  Object(h.attachMediaStream)(t.audio, e.stream.stream));
					else if (
						((!1 !== i.muted && "video_element_muted" !== i.muted) ||
							(t.video.removeAttribute("muted"), (t.video.muted = !1)),
						t.div.appendChild(t.video),
						window.MediaStream && (f.isSafari() || "iOS" === f.getBrowserOS()))
					) {
				...
				F = function(e) {
							...
							: (e.stunServerUrl &&
							  ...
							  e.turnServer &&
									(e.turnServer instanceof Array
										...
										: ("auto" !== e.turnServer.mode && "manual" !== e.turnServer.mode) ||
					...
					(t.iceCandidateTimer = setTimeout(function() {
						(t.iceCandidateTimer = null),
							r.default.debug(
								"[".concat(t.clientId, "]Candidates collected: ").concat(t.iceCandidateCount)
							),
							t.moreIceComing && ((t.moreIceComing = !1), t.markActionNeeded());
					}, Object(a.getParameter)("CANDIDATE_TIMEOUT"))),
						...
						o = function(n) {
							...
							if ((i = n.match(/m=video.*\r\n/)) && e.minVideoBW && e.maxVideoBW) {
								...
								var o = 0,
									s = 0;
								"h264" === e.codec
									? ((o = n.search(/a=rtpmap:(\d+) H264\/90000\r\n/)),
									  (s = n.search(/H264\/90000\r\n/)))
									: "vp8" === e.codec &&
									  ((o = n.search(/a=rtpmap:(\d+) VP8\/90000\r\n/)),
								...
								Object.keys(n).forEach(function(i) {
									...
									t.isSubscriber &&
										...
										e({
											...
											frameDropped:
												parseInt(a.googDecodingPLC) + parseInt(a.googDecodingPLCCNG) + "",
							...
							if (t.actionNeeded) {
								if ("new" === t.state || "established" === t.state)
									t.peerConnection.createOffer(
										...
										function(e) {
											r.default.debug(
												"[" + t.clientId + "]peer connection create offer failed ",
												e
											);
										},
										t.mediaConstraints
									...
									(t.prevOffer = t.peerConnection.localDescription.sdp),
										...
										t.offerCandidates.length ||
											(r.default.warning("[".concat(t.clientId, "]No Ice Candidate generated")),
											Object(a.getParameter)("SHIM_CANDIDATE")
												? (r.default.debug("Shimming fake candidate"),
												  (t.prevOffer +=
														"a=candidate:2243255435 1 udp 2122194687 192.168.0.1 30000 typ host generation 0 network-id 1\r\n"))
												: r.default.error(
														"[".concat(t.clientId, "]None Ice Candidate not allowed")
												  )),
									...
									t.peerConnection.createAnswer(
										function(e) {
											if (
												...
												var n = new Date();
												r.default.debug(
													"[" + t.clientId + "]" + n.getTime() + ": Starting ICE in responder"
												),
													(t.iceStarted = !0);
											}
										},
										function(e) {
											r.default.debug(
												"[" + t.clientId + "]peer connection create answer failed ",
												e
											);
										},
										t.mediaConstraints
								...
								t.peerConnection
									...
									.then(function() {
										t.onnegotiationneeded &&
											t.onnegotiationneeded(t.peerConnection.localDescription.sdp);
									})
									.catch(function(e) {
							...
							"new" === t.state
								? "OFFER" === a.messageType
									? ((n = { sdp: a.sdp, type: "offer" }),
									  ...
									  t.markActionNeeded())
									: t.error(
											"Illegal message for this state: " + a.messageType + " in state " + t.state
									  )
								: "offer-sent" === t.state
								? "ANSWER" === a.messageType
									? (((n = {
							...
							t.peerConnection.getStats().then(function(i) {
								...
								i.forEach(function(i) {
									if (t.isSubscriber) {
										if (
											"track" === i.type &&
											(~i.id.indexOf("video") || ~i.trackIdentifier.indexOf("v"))
										) {
							...
							t.getStats(function(t) {
								t.forEach(function(e) {
									"outbound-rtp" === e.type &&
										"video" === e.mediaType &&
										e.googFramesEncoded &&
										((e.googFrameRateSent = ((e.googFramesEncoded - p) / 3).toString()),
										(p = e.googFramesEncoded)),
										"inbound-rtp" === e.type &&
											-1 != e.id.indexOf("55543") &&
											(e.googFrameRateReceived &&
												((e.googFrameRateReceived = ((e.googFrameReceived - m) / 3).toString()),
												(m = e.googFrameReceived)),
											e.googFrameRateDecoded &&
												((e.googFrameRateDecoded = ((e.googFramesDecoded - f) / 3).toString()),
										...
										n.push(e),
											...
											"track" !== e.type ||
												(-1 == e.id.indexOf("55543") &&
													...
													null != e.audioLevel) ||
												((u.googFrameWidthReceived = e.frameWidth ? e.frameWidth + "" : "0"),
											...
											"candidate-pair" === e.type &&
												(0 == e.availableIncomingBitrate
													? (l.googAvailableSendBandwidth = e.availableOutgoingBitrate + "")
									...
									? "OFFER" === a.messageType
										? ((a.sdp = l(a.sdp)),
										  ...
										  t.peerConnection.setRemoteDescription(
												...
												function(e) {
													r.default.info(
														"[" + t.clientId + "]setRemoteDescription failed: " + e.name
													);
												}
										  ),
										  (t.state = "offer-received"),
										...
										? ((a.sdp = l(a.sdp)),
										  ...
										  -1 !== a.sdp.indexOf("a=group:BUNDLE")
												? ((a.sdp = a.sdp.replace(
												  ...
												  (a.sdp = a.sdp.replace(/a=mid:video/, "a=mid:sdparta_1")))
												: ((a.sdp = a.sdp.replace(/a=mid:audio/, "a=mid:sdparta_0")),
										  ...
										  t.peerConnection.setRemoteDescription(
												...
												function(e) {
													r.default.info(
														"[" + t.clientId + "]setRemoteDescription failed: " + e
													);
												}
										  ),
										  (t.state = "established"))
							...
							t.getStats(function(t) {
								t.forEach(function(e) {
									("inbound-rtp" !== e.type && "inboundrtp" !== e.type) ||
										"video" !== e.mediaType ||
										(e.googFrameRateDecoded &&
											((e.googFrameRateDecoded = ((e.googFramesDecoded - u) / 3).toString()),
								...
								function(n) {
									...
									try {
										for (
											...
											var f = l.value;
											i.push(f),
												("outbound-rtp" !== f.type && "outboundrtp" !== f.type) ||
													"video" !== f.mediaType ||
													-1 !== f.id.indexOf("rtcp") ||
													((s.id = f.id),
													(s.type = f.type),
													...
													(s.packetsSent = f.packetsSent ? f.packetsSent + "" : "0"),
													(s.googPlisReceived = f.pliCount ? f.pliCount + "" : "0"),
													(s.googNacksReceived = f.nackCount ? f.nackCount + "" : "0"),
													(s.googFirsReceived = f.firCount ? f.firCount + "" : "0"),
												...
												("outbound-rtp" !== f.type && "outboundrtp" !== f.type) ||
													...
													((o.id = f.id),
													(o.type = f.type),
													(o.mediaType = f.mediaType),
													(o.bytesSent = f.bytesSent ? f.bytesSent + "" : "0"),
													(o.packetsSent = f.packetsSent ? f.packetsSent + "" : "0")),
												("inbound-rtp" !== f.type && "inboundrtp" !== f.type) ||
													...
													(c.bytesReceived = f.bytesReceived ? f.bytesReceived + "" : "0"),
													(c.packetsLost = f.packetsLost ? f.packetsLost + "" : "0"),
													(c.packetsReceived = f.packetsReceived
														? f.packetsReceived + ""
														: "0"),
													(c.googJitterReceived = f.jitter ? f.jitter + "" : "0")),
												("inbound-rtp" !== f.type && "inboundrtp" !== f.type) ||
													"video" !== f.mediaType ||
													f.isRemote ||
													-1 !== f.id.indexOf("rtcp") ||
													...
													(d.bytesReceived = f.bytesReceived ? f.bytesReceived + "" : "0"),
													...
													(d.googFramesDecoded = f.framesDecoded
														? f.framesDecoded + ""
														: "0"),
													(d.packetsLost = f.packetsLost ? f.packetsLost + "" : "0"),
													(d.packetsReceived = f.packetsReceived
														? f.packetsReceived + ""
														: "0"),
													(d.googJitterBufferMs = f.jitter ? f.jitter + "" : "0"),
													(d.googNacksSent = f.nackCount ? f.nackCount + "" : "0"),
													(d.googPlisSent = f.pliCount ? f.pliCount + "" : "0"),
													(d.googFirsSent = f.firCount ? f.firCount + "" : "0")),
												-1 !== f.id.indexOf("outbound_rtcp_video") &&
													(s.packetsLost = f.packetsLost ? f.packetsLost + "" : "0");
										}
									} catch (e) {
										(r = !0), (u = e);
									} finally {
				...
				Z = function(e) {
					...
					return (
						null !== window.navigator.userAgent.match("Firefox")
							? ((t.browser = "mozilla"), (t = B(e)))
							: "iOS" === f.getBrowserOS() || f.isSafari()
							? (r.default.debug("[" + t.streamId + "][" + t.clientId + "]Safari"),
							  ((t = j(e)).browser = "safari"))
				...
				ee = function(e, t, n) {
					...
					var a = 0,
						...
						u = function(e) {
							r.default.error("Failed to GetUserMedia", e.name, e.code, e.message, e),
								a++,
								s ||
									((s = !0),
									setTimeout(function() {
						...
						l = function() {
							...
							if (
								(r.default.debug("GetUserMedia", JSON.stringify(t)),
					...
					if (
						...
						e.video || e.audio || e.screen)
					)
						if (e.screen) {
							if (z())
								return e.screen.sourceId
									? X(e.screen.sourceId, e.screen, function(e, t) {
											e ? u(e) : d(t);
									  })
							...
							if (f.isFireFox()) {
								...
								r.default.debug(
									"[" + i.streamId + "]Screen access on chrome stable, looking for extension"
								);
								try {
									...
									r.default.debug(
										"[" + i.streamId + "]AgoraRTC screensharing plugin is not accessible"
									);
									return void n({
								...
								if (window.navigator.mediaDevices.getDisplayMedia) {
									var p = {};
									return (
										"number" == typeof e.screen.width && "number" == typeof e.screen.height
											? (p.video = {
													width: {
										...
										r.default.debug("use getDisplayMedia, constraints:", p),
					...
					return (
						...
						(e._init = function(t, n) {
							(e.state = e.states.INITING),
								...
								e._reloadDevicesInfo(
									...
									function(t) {
										r.default.warning("Device Detection functionality cannot start properly."),
											(e.state = e.states.UNINIT),
											n && n(t);
									}
								);
						...
						(e._enumerateDevices = function(e, t) {
							if (!navigator.mediaDevices || !navigator.mediaDevices.enumerateDevices)
								return (
									r.default.warning("enumerateDevices() not supported."),
									...
									i.forEach(function(t) {
										...
										switch (t.device.kind) {
											...
											case "videoinput":
												...
												break;
											default:
												r.default.warning("Unknown device change", n),
				...
				ce = function(e, t, n, i, a) {
					if ((_e(n) && (n = 1), (i = i || 255), _e(a) && (a = !0), _e(e)))
				...
				le = function(e, t, n, i) {
					return (
						...
						_e(i) && (i = !0),
						Ie(e) && (!i || ge(e)) && e.length >= t && e.length <= n
					);
				},
				pe = function(e, t, n) {
					return ve(e) && e >= t && e <= n;
			...
			var Ee = function(e) {
					ce(e, "profileName"),
						...
						oe(e, "profileName", Object.keys(a.SUPPORT_RESOLUTION_LIST));
				...
				be = function(e) {
					return Object.keys(a.SUPPORT_RESOLUTION_LIST)
						.filter(function(t) {
			...
			var Re = function(e) {
					...
					function n() {
						...
						t.getVideoTrack() === this
							? (r.default.debug("Video Track Ended"), (e.type = "videoTrackEnded"), (e.track = this))
							: t.getAudioTrack() === this
							? (r.default.debug("Audio Track Ended"), (e.type = "audioTrackEnded"), (e.track = this))
							: r.default.debug("Detached Track ended", this.kind, this.label, this),
					...
					return (
						...
						(function(e) {
							(e.audioMixing = {
								...
								(e.loadAudioBuffer = function(t, n, i) {
									...
									var s = function(t) {
											r.default.error("[".concat(e.streamId, "] loadAudioBuffer Failed: ") + t),
												a(x.LOAD_AUDIO_FAILED);
										},
											...
											if (c.status > 400) s("".concat(c.status, " ").concat(c.statusText));
												...
												e.audioMixing.audioContextInited || e._initAudioContext(),
													e.audioMixing.ctx.decodeAudioData(
														...
														function(t) {
															r.default.error(
																"[".concat(e.streamId, "] decodeAudioData Failed: "),
																t
															),
																a(t);
														}
								...
								(e.createAudioBufferSource = function(t) {
									...
									if (e.audioMixing.buffer[t.id]) {
										...
										if (
											(a.connect(s),
											s.connect(e.audioMixing.mediaStreamDest),
											(a.gainNode = s),
											t.loop)
										)
									...
									return (
										r.default.error("[".concat(e.streamId, "] "), "AUDIOBUFFER_NOT_FOUND", t.id),
										n(!1),
										!1
									);
								}),
								...
								(e._isSoundExists = function(t) {
									return (
										...
										(r.default.error("SoundId not exists. #".concat(t.soundId)), !1)
									);
								}),
								(e._initAudioContext = function() {
									...
									(e.audioMixing.ctx = Object(ye.a)()),
										(e.audioMixing.mediaStreamSource = e.audioMixing.ctx.createMediaStreamSource(
											e.stream
										)),
									...
									if (
										...
										var n = (e.pc.peerConnection && e.pc.peerConnection.getSenders()).find(function(
												e
											) {
								...
								(e._reloadInEarMonitoringMode = function(t) {
									if (t) {
										if (!e.audioMixing.inEarMonitoringModes[t])
											return r.default.error(
												"[".concat(e.streamId, "] Invalid InEarMonitoringMode ").concat(t)
											);
										...
										case e.audioMixing.inEarMonitoringModes.ALL:
											for (var n in e.audioMixing.sounds) {
												...
												i &&
													...
													(i.source.gainNode.connect(e.audioMixing.ctx.destination),
									...
									switch (e.audioMixing.inEarMonitoring) {
										...
										case e.audioMixing.inEarMonitoringModes.ALL:
											e.audioMixing.mediaStreamSource.connectedToDestination ||
												(e.audioMixing.mediaStreamSource.connect(e.audioMixing.ctx.destination),
								...
								(e._startAudioMixingBufferSource = function(t) {
									...
									return (
										...
										a
											? (a.addEventListener("ended", e._audioMixingFinishedListener, {
													once: !0
											  }),
								...
								(e._stopAudioMixingBufferSource = function(t) {
									...
									return n
										? (n.removeEventListener("ended", e._audioMixingFinishedListener),
										  e.audioMixing.mediaStreamSource.connect(e.audioMixing.mediaStreamDest),
										  n.stop(),
										  n.gainNode && n.gainNode.disconnect && n.gainNode.disconnect(),
										  (n.buffer = null),
								...
								(e._audioMixingFinishedListener = function() {
									...
									t.state === e.audioMixing.states.IDLE &&
										...
										(r.default.debug("Recycled buffer ".concat(t.options.filePath)),
								...
								(e._playOneEffect = function(t, n) {
									...
									if (
										...
										t.playTime,
										t.replace,
										Object(f.isSafari)() && Object(f.getBrowserVersion)() < 12)
									) {
										var o = "BROWSER_NOT_SUPPORT";
										return (
											r.default.error("[".concat(e.streamId, "] Cannot _playOneEffect: "), o),
											n(o)
										);
									}
									e.audioMixing.audioContextInited || e._initAudioContext(),
									...
									if (s.state === e.audioMixing.states.IDLE) {
										if (void 0 !== t.cycle && !t.cycle > 0)
											return (
												(o = "Invalid Parmeter cycle: " + t.cycle),
												r.default.error("[".concat(e.streamId, "] ").concat(i), o),
												n(o)
											);
										if (
											(_e(a) && (t.cacheResource = !0),
											...
											e.loadAudioBuffer(t.filePath, t.filePath, function(i) {
												if (i)
													(s.state = e.audioMixing.states.IDLE),
														n ? n(i) : r.default.error("[".concat(e.streamId, "] "), i);
												else {
										  ...
										  i.state === e.audioMixing.states.PAUSED
											? (e._stopAudioMixingBufferSource(t),
											  ...
											  e.audioMixing.buffer[i.options.filePath] &&
													...
													(r.default.debug("Recycled buffer ".concat(i.options.filePath)),
													delete e.audioMixing.buffer[i.options.filePath]),
											  void (n && n(null)))
											: void e._handleAudioMixingInvalidStateError("_stopOneEffect", t, n)
										: n("SOUND_NOT_EXISTS");
								}),
									...
									if (i.state === e.audioMixing.states.BUSY)
										return e._stopAudioMixingBufferSource(t)
											? ((i.pauseAt = Date.now()),
											  (i.state = e.audioMixing.states.PAUSED),
											  i.resumeAt
													? (i.pauseOffset = i.pauseAt - i.resumeAt + i.resumeOffset)
													: (i.pauseOffset = i.pauseAt - i.startAt + i.startOffset),
											  n && n(null))
											: void e._handleAudioMixingNoSourceError("_pauseOneEffect", t, n);
								...
								(e._getOneEffectDuration = function(t) {
									var n = e.audioMixing.sounds[t.soundId];
									return n.options && n.options.filePath && e.audioMixing.buffer[n.options.filePath]
								...
								(e._getOneEffectCurrentPosition = function(t, n) {
									...
									return i.state === e.audioMixing.states.PAUSED
										...
										: i.state === e.audioMixing.states.BUSY
										? i.resumeAt
											? (Date.now() - i.resumeAt + i.resumeOffset + i.startOffset) %
											  e._getOneEffectDuration(t)
											: (Date.now() - i.startAt + i.startOffset) % e._getOneEffectDuration(t)
										: void (
												n &&
								...
								(e.startAudioMixing = function(t, n) {
									...
									var r = t.filePath,
										...
										u = t.playTime,
										l = t.replace;
									ce(r, "filePath", 1, Object(a.getParameter)("FILEPATH_LENMAX"), !1),
										de(u, "playTime", 0, 1e8),
										!_e(c) && de(c, "cycle"),
										!_e(d) && ue(d, "loop"),
										!_e(l) && ue(l, "replace"),
										!_e(s) && ue(s, "cacheResource");
									var p = S()({ soundId: -1 }, t);
								...
								(e.playEffect = function(t, n) {
									...
									var r = t.soundId,
										...
										c = t.cycle;
									de(r, "soundId", 1, 1e4),
										ce(s, "filePath", 0, Object(a.getParameter)("FILEPATH_LENMAX"), !1),
										!_e(c) && de(c, "cycle"),
									...
									for (var c in e.audioMixing.sounds) {
										...
										-1 !== d.soundId &&
											((d.state !== e.audioMixing.states.BUSY &&
												...
												(r++, e._stopOneEffect({ soundId: c }, s)));
									}
									r || n(null);
								}),
								(e.preloadEffect = function(t, n, i) {
									...
									de(t, "soundId", 1, 1e4),
										ce(n, "filePath", 1, Object(a.getParameter)("FILEPATH_LENMAX"), !1),
								...
								(e.pauseAllEffects = function(t) {
									...
									for (var c in e.audioMixing.sounds)
										"-1" !== c &&
											e.audioMixing.sounds[c].state === e.audioMixing.states.BUSY &&
											(r++, e._pauseOneEffect({ soundId: c }, s));
									r || n(null);
								}),
								...
								(e.resumeAllEffects = function(t) {
									...
									for (var c in e.audioMixing.sounds)
										"-1" !== c &&
											e.audioMixing.sounds[c].state === e.audioMixing.states.PAUSED &&
											(r++, e._resumeOneEffect({ soundId: c }, s));
									r || n(null);
								}),
								...
								(e.setEffectsVolume = function(t, n) {
									...
									for (var a in (de(t, "volume", 0, 100),
						...
						(function(e, t) {
							(e.videoConstraint = {}),
								...
								Object(f.isLegacyChrome)() ||
									(e.videoConstraint.frameRate = {
										ideal: 30,
										max: 30
									}),
								(e.audioConstraint = {}),
								t.microphoneId &&
									(e.audioConstraint.deviceId = {
								...
								Object(f.isLegacyChrome)() ||
									(e.audioProcessing &&
										(void 0 !== e.audioProcessing.AGC &&
											(Object(f.isFireFox)()
												? (e.audioConstraint.autoGainControl = e.audioProcessing.AGC)
												: Object(f.isChrome)() &&
												  ((e.audioConstraint.googAutoGainControl = e.audioProcessing.AGC),
												  (e.audioConstraint.googAutoGainControl2 = e.audioProcessing.AGC))),
										void 0 !== e.audioProcessing.AEC &&
											(e.audioConstraint.echoCancellation = e.audioProcessing.AEC),
										void 0 !== e.audioProcessing.ANS &&
											(Object(f.isFireFox)()
												? (e.audioConstraint.noiseSuppression = e.audioProcessing.ANS)
												: Object(f.isChrome)() &&
												  (e.audioConstraint.googNoiseSuppression = e.audioProcessing.ANS)))),
								(e.screenConstraint = {}),
								t.sourceId && (e.screenConstraint.sourceId = t.sourceId),
								t.extensionId && Object(f.isChrome)()
								...
								(e.setVideoResolution = function(n) {
										...
										return a && a.video
											? ((e.videoConstraint = S()(e.videoConstraint, {
											  ...
											  (s =
													...
													e.stream.getVideoTracks()[0]) && s.applyConstraints
													? (r.default.debug(
									...
									(e.videoConstraint = S()(e.videoConstraint, {
										...
										(s = e.stream && e.stream.getVideoTracks && e.stream.getVideoTracks()[0]) &&
										s.applyConstraints
											? (r.default.debug(
													"setVideoResolution applyConstraints",
													e.videoConstraint
								...
								(e.setVideoBitRate = function(n) {
									...
									return "object" === re()(n) && n instanceof Array && n.length > 1
								...
								(e.setScreenProfile = function(t) {
									...
									return i && i.screen
										? (e.screenConstraint.mandatory
												? ((e.screenConstraint.mandatory.maxWidth = i.screen.width),
												  ...
												  i.screen.frameRate &&
														...
														(e.screenConstraint.mandatory.maxFrameRate =
															i.screen.frameRate.max)))
												: (e.screenConstraint = S()(e.screenConstraint, i.screen)),
									...
									if (((e.profile = n), a && a.video)) {
										(e.profile = a.profileName),
											...
											e.connectionSpec &&
												...
												((e.connectionSpec.minVideoBW = a.attributes.minVideoBW),
								...
								(e.setVideoEncoderConfiguration = function(t) {
									...
									t.resolution &&
										(de(t.resolution.width, "config.resolution.width"),
										de(t.resolution.height, "config.resolution.height"),
										e.setVideoResolution([t.resolution.width, t.resolution.height])),
										t.frameRate &&
											(de(t.frameRate.min, "config.frameRate.min"),
											de(t.frameRate.max, "config.frameRate.max"),
											e.setVideoFrameRate([t.frameRate.min, t.frameRate.max])),
										t.bitrate &&
											(de(t.bitrate.min, "config.bitrate.min", 1, 1e7),
											de(t.bitrate.max, "config.bitrate.max", 1, 1e7),
								...
								(e.getSupportedProfile = function(t) {
									...
									if (!e.stream.getVideoTracks)
										return (i = "TRACK_NOT_SUPPORT"), r.default.error(i), n(i);
									var a = e.stream.getVideoTracks()[0];
									if (!a) return (i = "NO_VIDEO_TRACK_FOUND"), r.default.error(i), n(i);
									if (!a.getCapabilities)
										return (i = "GETCAPABILITY_NOT_SUPPORT"), r.default.error(i), n(i);
									var s = a.getCapabilities();
									return n(null, be(s));
								});
						})(t, e),
						t.on("collectStats", function(e) {
								...
								e.promises.push(
									new Promise(function(e) {
										...
										t.pc && t.pc.isSubscriber
											? null !== window.navigator.userAgent.match("Firefox") &&
											  (ne(n, "videoReceiveResolutionHeight", t.videoHeight),
											  ne(n, "videoReceiveResolutionWidth", t.videoWidth))
											: t.pc &&
											  !t.pc.isSubscriber &&
											  ((Object(f.isSafari)() || Object(f.isFireFox)()) &&
													(ne(n, "videoSendResolutionHeight", t.videoHeight),
													ne(n, "videoSendResolutionWidth", t.videoWidth)),
											  (Object(f.isSafari)() || Object(f.isFireFox)()) &&
													t.uplinkStats &&
													ne(
														n,
									...
									new Promise(function(e) {
										...
										return (
											t.traffic_stats && t.pc && t.pc.isSubscriber
												? (ne(n, "accessDelay", t.traffic_stats.access_delay),
												  ne(n, "endToEndDelay", t.traffic_stats.e2e_delay),
												  ne(n, "videoReceiveDelay", t.traffic_stats.video_delay),
												  ne(n, "audioReceiveDelay", t.traffic_stats.audio_delay))
												: t.traffic_stats &&
												  t.pc &&
												  !t.pc.isSubscriber &&
												  ne(n, "accessDelay", t.traffic_stats.access_delay),
						...
						(t.checkDualStreamEnabled = function() {
							if (Object(a.getParameter)("DUALSTREAM_OPERATION_CHECK") && t.isDualStream) {
								return (
									r.default.error("Operation not permitted: ".concat("DUAL_STREAM_ENABLED")),
									"DUAL_STREAM_ENABLED"
								);
							}
							return !1;
						...
						(t.init = function(i, a) {
							...
							var d = Math.random()
								.toString()
								.slice(3);
							(this._streamInitID = d),
								t.videoSource
									? (t.videoName = "videoSource")
									: t.video && (t.videoName = ie.searchDeviceNameById(e.cameraId) || "default"),
								t.audioSource
									? (t.audioName = "audioSource")
									: t.audio && (t.audioName = ie.searchDeviceNameById(e.microphoneId) || "default"),
							...
							try {
											...
											function(i) {
												...
												if (t._streamInitID !== d) {
													...
													a = {
														...
														info:
															"stream initialization is aborted because of another stream.init"
													};
													return r.default.error(t.streamId, a.info), void s(a);
												}
												t.dispatchEvent({
													...
													t.hasVideo() &&
														Object(te.g)(
															...
															function(e) {
																r.default.warning(
																	"[".concat(t.streamId, "] vsResHack failed: "),
																	e
																);
															}
														),
													e.screen &&
														...
														(t.stream.getVideoTracks()[0].onended = function() {
															t.dispatchEvent({
								...
								r.default.error("[".concat(t.streamId, "] Stream init: "), e),
									s({ type: "error", msg: e.message || e });
							}
						}),
						...
						(t.close = function() {
							...
							if (
								(r.default.debug("[".concat(t.streamId, "] Close stream with id"), t.streamId),
								void 0 !== t.stream)
							) {
							...
							Object(f.isSafari)() &&
								...
								t.pc.peerConnection.getSenders().forEach(function(e) {
									e &&
										(r.default.debug("[".concat(t.streamId, "] Remove Track"), e),
						...
						(t.enableAudio = function() {
							...
							return (
								...
								t.userMuteAudio ||
									r.default.warning("[".concat(t.streamId, "] User already enableAudio")),
								(t.userMuteAudio = !1),
						...
						(t.disableAudio = function() {
							...
							r.default.deprecate(
								...
								t.userMuteAudio &&
									r.default.warning("[".concat(t.streamId, "] User already disableAudio")),
								(t.userMuteAudio = !0);
							var n = t._muteAudio();
							return e(null, n), n;
						}),
						(t.enableVideo = function() {
							...
							return (
								...
								t.userMuteVideo ||
									r.default.warning("[".concat(t.streamId, "] User already enableVideo")),
								(t.userMuteVideo = !1),
						...
						(t.disableVideo = function() {
							...
							r.default.deprecate(
								...
								t.userMuteVideo &&
									r.default.warning("[".concat(t.streamId, "] User already disableVideo")),
								(t.userMuteVideo = !0),
						...
						(t.unmuteAudio = function() {
							...
							return (
								t.userMuteAudio ||
									r.default.warning("[".concat(t.streamId, "] User already unmuteAudio")),
								(t.userMuteAudio = !1),
								n(null, (e = !t.peerMuteAudio && t._unmuteAudio())),
								e
							);
						...
						(t.muteAudio = function() {
							...
							t.userMuteAudio && r.default.warning("[".concat(t.streamId, "] User already muteAudio")),
								(t.userMuteAudio = !0);
							var n = t._muteAudio();
							return e(null, n), n;
						}),
						(t.unmuteVideo = function() {
							...
							return (
								t.userMuteVideo ||
									r.default.warning("[".concat(t.streamId, "] User already unmuteVideo")),
								(t.userMuteVideo = !1),
								t.lowStream && (t.lowStream.userMuteVideo = !1),
								n(null, (e = !t.peerMuteVideo && t._unmuteVideo())),
								e
						...
						(t.muteVideo = function() {
							...
							t.userMuteVideo && r.default.warning("[".concat(t.streamId, "] User already muteVideo")),
								(t.userMuteVideo = !0),
								t.lowStream && (t.lowStream.userMuteVideo = !0);
							var n = t._muteVideo();
							return e(null, n), n;
						...
						(t._unmuteAudio = function() {
							return (
								r.default.debug("[".concat(t.streamId, "] Unmuted audio stream with id "), t.streamId),
						...
						(t._muteAudio = function() {
							return (
								r.default.debug("[".concat(t.streamId, "] Muted audio stream with id "), t.streamId),
						...
						(t._unmuteVideo = function() {
							return (
								r.default.debug("[".concat(t.streamId, "] Unmuted video stream with id"), t.streamId),
								!(
									!t.initialized ||
									void 0 === t.stream ||
						...
						(t._muteVideo = function() {
							return (
								r.default.debug("[".concat(t.streamId, "] Muted video stream with id"), t.streamId),
								!!(
									t.initialized &&
									void 0 !== t.stream &&
									t.stream.getVideoTracks().length &&
						...
						(t.addTrack = function(i) {
							...
							if ((t.pc && t.pc.addTrack(i, t.stream), "audio" == i.kind)) {
								...
								c && (s.addTrack(c), (t.audio = !0), (e.audio = !0)),
									(t.stream = s),
									(t.audioLevelHelper = null),
						...
						(t.removeTrack = function(n) {
							...
							t.pc && t.pc.removeTrack(n, t.stream),
								...
								"live" == n.readyState &&
									(n.stop(),
									r.default.debug("[".concat(t.streamId, "] Track ").concat(n.kind, " Stopped"))),
								i();
						}),
						(t.setAudioOutput = function(e, n, i) {
							var a = o.b.reportApiInvoke(t.sid, {
							...
							return le(e, 1, 255)
								? ((t.audioOutput = e),
								  t.player
										...
										: a())
								: (r.default.error("[".concat(t.streamId, "] setAudioOutput Invalid Parameter"), e),
								  a(x.INVALID_PARAMETER));
						}),
						(t.play = function(e, n, i) {
							"function" == typeof n && ((i = n), (n = null)),
								r.default.debug("[".concat(t.streamId, "] play()."), e, n);
							var a = o.b.reportApiInvoke(t.sid, {
								name: "Stream.play",
								options: arguments,
								tag: "tracer",
							...
							if (
								(ce(e, "elementID"),
								_e(n) ||
									(_e(n.fit) || oe(n.fit, "fit", ["cover", "contain"]),
									_e(n.muted) || ue(n.muted, "muted")),
								t.player)
							)
								r.default.warning(
									"[".concat(
								...
								t.on("player-status-change", function e(n) {
									if (((s[n.mediaType] = n), s.audio && s.video))
										if (
											...
											s.video.isErrorState || s.audio.isErrorState)
										) {
											...
											"aborted" === s.video.status && "aborted" === s.audio.status
												? a({
														status: "aborted",
														reason: "stop",
														video: s.video,
						...
						(t.stop = function() {
							...
							r.default.debug("[".concat(t.streamId, "] Stop stream player with id "), t.streamId),
								t.player
									? (t.player.destroy(), delete t.player)
									: r.default.error("[".concat(t.streamId, "] Stream.stop(): Stream is not playing")),
								t._flushAudioMixingMuteStatus(!0),
								e();
						}),
						...
						(t.resume = function() {
							var e, n;
							return t.player
								? (t.player.video && t.player.video.play && (e = t.player.video.play()),
								  (e = e || Promise.resolve()),
						...
						(t.getVideoTrack = function() {
							...
							r.default.info("[".concat(t.streamId, "] getVideoTrack None")),
						...
						(t.getAudioTrack = function() {
							...
							r.default.info("[".concat(t.streamId, "] getAudioTracks None")),
								e(null, "getAudioTracks None");
						}),
						(t._replaceMediaStreamTrack = function(e, n, i) {
							if (t.stream) {
								if ("video" == e.kind) {
									if ((o = t.stream.getVideoTracks()[0]))
										return (
											t.userMuteVideo && (e.enabled = !1),
											t.stream.removeTrack(o),
											t.stream.addTrack(e),
											r.default.debug(
												"["
											...
											"live" == o.readyState &&
												(o.stop(),
												r.default.debug(
													"[".concat(t.streamId, "] Track ").concat(o.kind, " Stopped")
												)),
											n && n()
										);
									...
									return (
										r.default.error(
											"[".concat(t.streamId, "] MEDIASTREAM_TRACK_NOT_FOUND ").concat(e.kind)
										),
										i(a)
									);
								}
								if ("audio" == e.kind) {
									...
									if ((o = t.stream.getAudioTracks()[0])) {
										...
										return (
											...
											t.player && t.player.video && (t.player.video.srcObject = t.stream),
											r.default.debug(
												"[".concat(t.streamId, "] _replaceMediaStreamTrack SUCCESS")
											),
											"live" == o.readyState &&
												(o.stop(),
												r.default.debug(
							...
							a = "NO_STREAM_FOUND";
							return (
								r.default.error("[".concat(t.streamId, "] _replaceMediaStreamTrack ").concat(a)),
								i && i(a)
							);
						}),
										...
										? void t.pc.replaceTrack(
												...
												function() {
													return (
														r.default.debug(
															"["
																.concat(t.streamId, "] PeerConnection.replaceTrack ")
																.concat(e.kind, " SUCCESS")
														),
						...
						(t._getPCStats = function(e) {
							return new Promise(function(n, i) {
													...
													e.forEach(function(e) {
														e.id &&
															((-1 === e.id.indexOf("recv") &&
																...
																("audio" === e.mediaType
																	? (ne(t, "audioReceiveBytes", e.bytesReceived),
																	  ne(t, "audioReceivePackets", e.packetsReceived),
																	  ne(t, "audioReceivePacketsLost", e.packetsLost))
																	: (ne(t, "videoReceiveBytes", e.bytesReceived),
																	  ne(t, "videoReceivePacketsLost", e.packetsLost),
															...
															((-1 === e.id.indexOf("send") &&
																...
																("audio" === e.mediaType
																	? (ne(t, "audioSendBytes", e.bytesSent),
																	  ne(t, "audioSendPackets", e.packetsSent),
																	  ne(t, "audioSendPacketsLost", e.packetsLost))
																	: (ne(t, "videoSendBytes", e.bytesSent),
																	  ne(t, "videoSendPackets", e.packetsSent),
																	  ne(t, "videoSendPacketsLost", e.packetsLost),
																	  ne(t, "videoSendFrameRate", e.googFrameRateSent),
																	  ne(
																			t,
																			"videoSendResolutionWidth",
								...
								return (
									t.pc.isSubscriber
										? (Object(f.isFireFox)() || Object(f.isSafari)()) &&
										  ((e.videoReceiveResolutionHeight && "0" !== e.videoReceiveResolutionHeight) ||
												(e.videoReceiveResolutionWidth &&
													"0" !== e.videoReceiveResolutionWidth) ||
												(ne(e, "videoReceiveResolutionHeight", t.videoHeight),
												ne(e, "videoReceiveResolutionWidth", t.videoWidth)))
										: ((Object(f.isSafari)() || Object(f.isFireFox)()) &&
												((e.videoSendResolutionHeight && "0" !== e.videoSendResolutionHeight) ||
													(e.videoSendResolutionWidth &&
														"0" !== e.videoSendResolutionWidth) ||
													(ne(e, "videoSendResolutionHeight", t.videoHeight),
													ne(e, "videoSendResolutionWidth", t.videoWidth))),
										  (Object(f.isSafari)() || Object(f.isFireFox)()) &&
												t.uplinkStats &&
												ne(e, "videoSendPacketsLost", t.uplinkStats.uplink_cumulative_lost)),
									Promise.resolve(e)
								);
							});
						}),
						(t.getAudioLevel = function() {
							...
							if (t.stream) {
								if (0 !== t.stream.getAudioTracks().length)
									return (
										(t.audioLevelHelper = new te.a(t.stream)), t.audioLevelHelper.getAudioLevel()
									);
								r.default.warning(
									"[".concat(t.streamId, "] can't get audioLevel beacuse no audio trace in stream")
								);
							} else
								r.default.warning(
									"[".concat(t.streamId, "] can't get audioLevel beacuse no stream exist")
								);
						}),
						...
						(t._switchVideoDevice = function(e, n, i) {
							...
							r.default.debug("[".concat(t.streamId, "] ").concat(a)),
								ee(
									a,
									function(a) {
										try {
											var r = function() {
												t.isPlaying() &&
													(t.stop(), t.elementID && t.play(t.elementID, t.playOptions)),
													(t.cameraId = e),
						...
						(t._switchAudioDevice = function(e, n, i) {
							...
							r.default.debug("[".concat(t.streamId, "] "), a),
								ee(
									a,
									function(a) {
										var r = function() {
				...
				Me = function(e) {
					...
					(t.needReconnect = !0),
						...
						(t.connectNext = function() {
							(t.isInit = !0),
								...
								t.hostIndex >= t.host.length
									? t.dispatchEvent(l({ type: "recover" }))
									: t.creatConnection();
						}),
						...
						(t.creatConnection = function() {
							if (
								((t.needReconnect = !0),
								r.default.debug("[" + t.clientId + "] start connect:" + t.host[t.hostIndex]),
								...
								if (n)
									(t.turnConfig.url = n[1]),
										Object(a.getParameter)("TURN_ENABLE_TCP") &&
											(t.turnConfig.tcpport = parseInt(n[2]) + 30),
										Object(a.getParameter)("TURN_ENABLE_UDP") &&
							...
							(t.connection.onopen = function(e) {
								r.default.debug("[" + t.clientId + "] websockect opened: " + t.host[t.hostIndex]),
									(t.needReconnect = !0),
									(t.isTimeout = !1),
									(t.isInit = !1),
									(t.sendbytes = 0),
									...
									if (e.data instanceof ArrayBuffer)
										...
										(t.lastMsgTime = Date.now()),
											n.hasOwnProperty("_id")
												? t.dispatchEvent(l({ type: n._id, msg: n }))
								...
								(t.connection.onclose = function(n) {
									t.needReconnect
										? t.isTimeout || t.isInit
											? (r.default.debug("[" + t.clientId + "] websockect connect timeout"),
										...
										: (r.default.debug("[" + t.clientId + "] websockect closeed"),
										  ke(e.onFailure, n),
										  clearTimeout(t.timeoutCheck),
										  t.dispatchEvent(l({ type: "close", event: n })),
					...
					var n = function(e) {
						...
						i && t.dispatcher.eventListeners[e.type]
							? (delete t.dispatcher.eventListeners[e.type],
							  e.msg && i.callback && i.callback(e.msg._result, e.msg._message))
							: r.default.warning("Detached Response", e.type, e.msg);
					};
					return (
									...
									function(e) {
										...
										i >= 0 && (n = t.requests.splice(i, 1)[0]),
											n && t.dispatcher.eventListeners[e.type]
												...
												: r.default.warning("handleSendError", n);
									}.bind(a)
								);
						}),
						(t.checkRequestTimeout = function() {
							for (
								var e = Math.ceil(
										Object(a.getParameter)("SIGNAL_REQUEST_TIMEOUT") /
											Object(a.getParameter)("SIGNAL_REQUEST_WATCH_INTERVAL")
									),
								...
								i.timeoutCounter >= e
									? (t.requests.splice(n, 1),
									  r.default.error("Request Timeout", i.timeoutCounter, i.message),
				...
				je = function(e, t) {
					...
					Object(a.getParameter)("PROXY_CS").map(function(c) {
						...
						Be("https://" + c + "/api/v1", s, function(s, u) {
							if (s)
								return (
									r.default.debug("[" + e.clientId + "] Request proxy server failed: ", s),
									i++,
									...
									void (
										i >= Object(a.getParameter)("PROXY_CS").length &&
										t &&
							...
							if (!n)
								if ((u = JSON.parse(u)).json_body) {
									...
									if (
										(r.default.debug("[" + e.clientId + "] App return:", l.servers), 200 !== l.code)
									) {
										s =
									...
									r.default.debug("[" + e.clientId + "] Get proxy server failed: no json_body"),
										o.b.requestProxyAppCenter(e.sid, {
											lts: d,
											succ: !1,
											APAddr: c,
				...
				We = function(e, t, n) {
					...
					t.map(function(c) {
						...
						!(function(e, t, n) {
							...
							if (s)
								return (
									r.default.debug("[" + e.clientId + "] Request worker manager failed: ", s),
									a++,
									o.b.requestProxyWorkerManager(e.sid, {
										lts: d,
										succ: !1,
										workerManagerAddr: c,
										ec: JSON.stringify(s),
				...
				He = function(e) {
					...
					return (
						e.forEach(function(e) {
							...
							e.address && e.tcp
								? (e.address.match(/^[\.\:\d]+$/)
										? (n = "".concat(e.address.replace(/[^\d]/g, "-"), ".edge.agora.io"))
										: (r.default.info(
												"[" +
													joinInfo.clientId +
													"] " +
								  ...
								  t.push(n))
								: r.default.error("[" + joinInfo.clientId + "] Invalid address format ", e);
						}),
						t
					);
				},
				Ge = function(e, t) {
					...
					(i = i.map(function(e) {
						return n.proxyServer
							? "https://".concat(n.proxyServer, "/ap/?url=").concat(e + "/api/v1")
						...
						!(function(e, t, n) {
							...
							o ||
								(e
									? (r.push(e), r.length >= i.length && t && t("ALL_REQUEST_FAILED"))
									: ((o = !0), t && t(null, n)));
						});
					});
				},
				...
				Ye = function(e, t, n, i) {
					...
					c && (d.detail[5] = JSON.stringify(c)),
						Object(Le.c)(
							e + "".concat(-1 === e.indexOf("?") ? "?" : "&", "action=wrtc_gateway"),
							d,
							function(c) {
								try {
									var d = JSON.parse(c);
									...
									d.addresses.forEach(function(e) {
										...
										e.ip && e.port
											? (e.ip.match(/^[\.\:\d]+$/)
											  ...
											  f.push(t))
											: r.default.error("[" + s.clientId + "] Invalid address format ", e);
									}),
									!f.length)
								) {
								...
								Ge(
									...
									function(t, n) {
										...
										o.b.reportApiInvoke(e.sid, {
											...
											Je[l] !== ot.DISCONNECTED && Je[l] !== ot.DISCONNECTING
												? p && d && d(g, u)
												: r.default.debug(
														"["
															.concat(
									...
									(function(e, t, n) {
										for (
											var i = new Date().getTime(),
												...
												u = function(t, i, a) {
													c &&
														(r.default.error("[" + e.clientId + "]", t, i, a),
														a && -1 === b.indexOf(a) && ((c = !1), n(a)));
												},
												l = Object(a.getParameter)("WEBCS_DOMAIN"),
												p = 0;
											p < l.length;
											++p
										) {
											...
											if ("string" == typeof l[p]) {
												...
												(f = e.proxyServer
													...
													r.default.debug(
														"[" + e.clientId + "] " + "Connect to choose_server: ".concat(f)
													),
													Ye(f, e, d, u);
										...
										var g = setTimeout(function() {
											if (!s)
												for (
													var t = Object(a.getParameter)("WEBCS_DOMAIN_BACKUP_LIST"), n = 0;
													n < t.length;
													++n
												)
										...
										function(i) {
											i
												? r.default.info("[" + e.clientId + "] Join failed: " + i)
												: Je[l] !== ot.DISCONNECTED && Je[l] !== ot.DISCONNECTING
												? (r.default.debug(
														"[" +
															e.clientId +
					...
					e.useProxyServer
						? (function n() {
								!(function(e, t) {
									...
									if (i)
										return (
											r.default.debug("[" + e.clientId + "]", i),
											r.default.debug(
												"[" + e.clientId + "] Request proxy will be restart in " + d + "s"
											),
											(s = setTimeout(function() {
												n();
											}, 1e3 * d)),
									...
									(e.proxyServer = c),
										...
										(e.turnServer.tcpport += ""),
										(e.turnServer.udpport += ""),
										o.b.setProxyServer(c),
										r.default.setProxyServer(c),
										p(c, t);
								});
						  })()
						: p(null, t);
				...
				Ke = function(e, t, n, i) {
					...
					return new Promise(function(c, d) {
						Object(Le.c)(
							e + "".concat(-1 === e.indexOf("?") ? "?" : "&", "action=stringuid"),
							s,
							function(u) {
								try {
									var l = JSON.parse(u),
								...
								if (!(g > 0 && g < Math.pow(2, 32))) {
									r.default.error(
										"[" + t.clientId + "] " + "Invalid Uint Uid ".concat(i, " => ").concat(g),
										l
									);
			...
			var at = function e(t) {
					...
					Object.defineProperty(b, "state", {
						...
						(function(e) {
							...
							(e.makeRequest = function(n, i, a) {
								if (void 0 === e.socket)
									return (
										r.default.error("[".concat(e.clientId, "] No socket available")),
										void t(a, x.INVALID_OPERATION)
									);
								try {
					...
					(b.p2pCounter = Object(te.f)(1e5)),
						...
						(b.setClientRole = function(e, t) {
							...
							b.makeRequest(
								...
								function(t, i) {
									if (
										(i && i.code && (t = P[i.code] || "UNKNOW_ERROR_" + i.code),
						...
						(b.join = function(e, n, i, s) {
							...
							var c = new Date().getTime(),
								d = e.uid;
							if (
								(b.inChannelInfo.joinAt && (b.inChannelInfo.duration += c - b.inChannelInfo.joinAt),
								(b.inChannelInfo.joinAt = c),
								b.state !== I)
							)
								return (
									r.default.error(
										"[".concat(b.clientId, "] GatewayClient.join Failed: state "),
										b.state
									),
									s && s(x.INVALID_OPERATION),
									void o.b.joinGateway(e.sid, {
										lts: c,
										succ: !1,
							...
							if (null != d && parseInt(d) !== d)
								return (
									r.default.error("[".concat(b.clientId, "] Input uid is invalid")),
									(b.state = v),
									s && s(x.INVALID_PARAMETER),
									void o.b.joinGateway(e.sid, {
										lts: c,
										succ: !1,
							...
							(b.joinInfo = S()({}, e)),
								...
								O(
									...
									function(n) {
										var d, u, p, f;
										(b.state = h),
											r.default.debug("[".concat(b.clientId, "] Connected to gateway server")),
											...
											(b.pingTimer = setInterval(function() {
												...
												if (++b.pingpongCounter >= e) {
													...
													r.default.warning(
														...
														b.socket &&
															...
															t - b.socket.getLastMsgTime() >
																Object(a.getParameter)("WEBSOCKET_TIMEOUT_MIN") &&
															((b.pingpongCounter = 0),
															b.socket.close(),
												...
												b.makeRequest(
													...
													function() {
														...
														var e = Date.now() - n;
														setTimeout(function() {
															Object(a.getParameter)("REPORT_STATS") &&
																b.makeRequest({
																	_type: "ping_back",
																	_message: {
																		pingpongElapse: e
													...
													function(e, t) {
														"TIMEOUT" !== e &&
															(r.default.error(
																"Ping Error ".concat(e, " ").concat(JSON.stringify(t))
															),
															t &&
																t.error_code &&
																b.socket &&
																...
																b.socket.signal.connection.readyState ===
																	WebSocket.OPEN &&
																(r.default.info("Disconnecting websocket connection"),
											...
											b.makeRequest(
												...
												(f = {
													...
													role: u,
													has_changed_gateway:
														Object(a.getParameter)("FORCE_CHANGED_GATEWAY_FLAG") ||
												...
												b.socket &&
													b.socket.signal &&
													b.socket.signal &&
													(p.addresses[b.socket.signal.hostIndex] &&
														((f.ap_response.ticket =
															p.addresses[b.socket.signal.hostIndex].ticket),
														delete p.addresses),
													b.joinInfo.turnServer &&
														"auto" === b.joinInfo.turnServer.mode &&
														b.socket.signal.turnConfig &&
														((b.joinInfo.turnServer.url = b.socket.signal.turnConfig.url),
														...
														b.socket.signal.turnConfig.udpport &&
															(b.joinInfo.turnServer.udpport =
																"" + b.socket.signal.turnConfig.udpport)),
													r.default.debug("Turn config", b.joinInfo.turnServer)),
												b.dispatchEvent({
												...
												function(t) {
													if (
														...
														r.default.info(
															"[".concat(b.clientId, "] Calling Leave() once joined")
														);
													...
													if (Qe[t] && b.rejoinAttempt < 4) {
														if ((b._doWithAction(Qe[t], i, s), b.leaveOnConnected)) {
															...
															(b.leaveOnConnected = null),
																a.onFailure(x.JOIN_CHANNEL_FAILED);
														}
													} else s && s(t);
													o.b.joinGateway(e.sid, {
														lts: c,
									...
									function(t) {
										r.default.error("[".concat(b.clientId, "] User join failed [").concat(t, "]")),
											s && s(t),
											o.b.joinGateway(e.sid, {
												lts: c,
												succ: !1,
						...
						(b.leave = function(e, t) {
							switch (b.state) {
								case v:
									return (
										r.default.debug(
											"[".concat(b.clientId, "] Client Already in DISCONNECTED status")
										),
										void T(e)
									);
								case _:
									return (
										r.default.error(
											"[".concat(b.clientId, "] Client Already in DISCONNECTING status")
										),
								...
								case I:
									if (b.leaveOnConnected)
										return (
											r.default.error("[".concat(b.clientId, "] Client.leave() already called")),
											void T(t, x.INVALID_OPERATION)
										);
							...
							if (n) r.default.error("[".concat(b.clientId, "] "), n);
								...
								for (var i in ((b.state = _), clearInterval(b.pingTimer), b.timers))
									b.timers.hasOwnProperty(i) && clearInterval(b.timers[i]);
								for (var i in (b.inChannelInfo.joinAt &&
									((b.inChannelInfo.duration += Date.now() - b.inChannelInfo.joinAt),
								...
								b.makeRequest(
									...
									function(t) {
										b.socket.close(),
											(b.socket = void 0),
											r.default.info("[".concat(b.clientId, "] Leave channel success")),
											(b.state = v),
											e && e(t);
									},
									function(e) {
										r.default.error("[".concat(b.clientId, "] Leave Channel Failed"), e),
											(b.state = h),
											t && t(e);
									}
								),
						...
						(b.publish = function(e, t, n, s) {
							var c = new Date().getTime(),
								d = !1;
							if (((e.publishLTS = c), "object" !== re()(e) || null === e))
								return (
									r.default.error("[".concat(b.clientId, "] Invalid local stream")),
									s && s(x.INVALID_LOCAL_STREAM),
							...
							if (!e.stream && void 0 === e.url)
								return (
									r.default.error("[".concat(b.clientId, "] Invalid local media stream")),
									s && s(x.INVALID_LOCAL_STREAM),
									void o.b.publish(b.joinInfo.sid, {
										lts: c,
										succ: !1,
							...
							if (b.state !== h)
								return (
									r.default.error("[".concat(b.clientId, "] User is not in the session")),
									s && s(x.INVALID_OPERATION),
									void o.b.publish(b.joinInfo.sid, {
										lts: c,
										succ: !1,
									...
									N(
										...
										function(t, n) {
											"success" === t
												...
												: r.default.error(
														"[".concat(b.clientId, "] Publish local stream failed"),
														t
												  );
										}
									);
									...
									(b.localStreams[e.getId()] = e),
											...
											callback: function(l) {
												r.default.debug(
													...
													b.makeRequest(
														...
														function(t, n) {
															r.default.error("Publish Failed: ".concat(t)),
																o.b.publish(b.joinInfo.sid, {
																	lts: c,
																	succ: !0,
																	audioName: e.hasAudio() && e.audioName,
																...
																"TIMEOUT" != t &&
																	(b.processPublishFailure(e), s && s(t));
														}
													);
											},
											audio: e.hasAudio(),
										...
										(e.pc.onnegotiationneeded = function(n) {
											...
											b.makeRequest(
												m(i),
												function(t) {
													r.default.debug("Negotating Stream ".concat(e.getId())),
														e.pc.processSignalingMessage(t.sdp);
												},
												function(e, t) {
											...
											e.pc.getVideoRelatedStats(function(t) {
												var n,
													...
													o =
														...
														b.socket.getLastMsgTime() &&
														Date.now() - b.socket.getLastMsgTime();
												o > Object(a.getParameter)("REPORT_STATS_TIMEOUT")
													? r.default.debug(
													...
													? b.makeReport(
															...
															(i = {}),
															Object.keys(n).forEach(function(e) {
																Object(a.getParameter)("STATS_FILTER")[e] ||
																	(i[nt(e)] = n[e]);
															}),
															{
													...
													: b.makeReport(
															(function(e) {
																...
																return (
																	Object.keys(e).forEach(function(n) {
																		Object(a.getParameter)("STATS_FILTER")[n] ||
																			(t[nt(n)] = e[n]);
																	}),
																	{
																		_type: "publish_related_stats",
						...
						(b.unpublish = function(e, t, n, i) {
							if ("object" !== re()(e) || null === e)
								return (
									r.default.error("[".concat(b.clientId, "] Invalid local stream")),
									void T(i, x.INVALID_LOCAL_STREAM)
								);
							if (b.state !== h)
								return (
									r.default.error("[".concat(b.clientId, "] User not in the session")),
									void T(i, x.INVALID_OPERATION)
								);
							if (
								(null != b.timers[e.getId()] &&
									(clearInterval(b.timers[e.getId()]),
								...
								if (e.local && void 0 !== b.localStreams[e.getId()]) {
									...
									r.default.error("[".concat(b.clientId, "] Invalid local stream")),
										T(i, x.INVALID_LOCAL_STREAM);
							else
								r.default.error("[".concat(b.clientId, "] User not in the session")),
									T(i, x.INVALID_OPERATION);
						}),
						(b.subscribe = function(e, t, n) {
							...
							if (
								...
								return (
									r.default.error("[".concat(b.clientId, "] Invalid remote stream")),
									n && n(x.INVALID_REMOTE_STREAM),
									void o.b.subscribe(b.joinInfo.sid, {
										lts: s,
										succ: !1,
							...
							if (
								b.state !== h &&
								(r.default.error("[".concat(b.clientId, "] User is not in the session")), !l)
							)
								return (
									(l = !0),
							...
							if (!e.local && b.remoteStreams.hasOwnProperty(e.getId()))
									...
									b.p2ps.set(p, e),
										...
										(e.pc.onaddstream = function(t, n) {
											if (
												...
												r.default.info(
													"[".concat(b.clientId, "] Remote stream subscribed with uid "),
													e.getId()
												);
												...
												if (
													...
													if (Object(f.isFireFox)() || Object(f.isSafari)()) {
														...
														Object(te.g)(
															...
															function(e) {
																return r.default.warning(
																	"[".concat(b.clientId, "] vsResHack failed: ") + e
																);
															}
														);
													}
												...
												a &&
													...
													(r.default.debug(
														"["
															...
															.concat(a.elementID, " StreamId ")
															.concat(a.getId())
													),
													(e.audioOutput = a.audioOutput),
													a.stop(),
													e.play(a.elementID, a.playOptions)),
														...
														n.forEach(function(n) {
															if (n && n.id) {
																...
																(-1 === n.id.indexOf("inbound_rtp") &&
																	...
																	"video" !== n.mediaType ||
																	((n.googFrameWidthReceived = e.videoWidth + ""),
																...
																setTimeout(function() {
																	var e =
																		...
																		b.socket.getLastMsgTime() &&
																		Date.now() - b.socket.getLastMsgTime();
																	e > Object(a.getParameter)("REPORT_STATS_TIMEOUT")
																		? r.default.debug(
										...
										(b.timers[e.getId() + "_RelatedStats"] = setInterval(function() {
											if (Object(a.getParameter)("REPORT_STATS") && e && e.pc) {
												var t =
													...
													b.socket.getLastMsgTime() &&
													Date.now() - b.socket.getLastMsgTime();
												if (t > Object(a.getParameter)("REPORT_STATS_TIMEOUT"))
																	...
																	t.forEach(function(t) {
																		-1 !== t.id.indexOf("recv") &&
																			...
																			(a ||
																				...
																				clearInterval(c),
																				o.b.reportApiInvoke(b.joinInfo.sid, {
								...
								r.default.error("[".concat(b.clientId, "] No such remote stream")),
									l ||
										((l = !0),
										n && n(x.NO_SUCH_REMOTE_STREAM),
										o.b.subscribe(b.joinInfo.sid, {
											lts: s,
											succ: !1,
											video: e.subscribeOptions && e.subscribeOptions.video,
						...
						(b.subscribeChange = function(e, t, n) {
							...
							b.makeRequest(
								...
								function(t, i) {
									r.default.error(
										"[".concat(b.clientId, "] Subscribe Change Failed ").concat(e.getId()),
										t,
										i
									),
										n && n(t, i);
						...
						(b.processSubscribeFailure = function(e) {
							e.p2pId && b.p2ps.get(e.p2pId) === e && b.p2ps.delete(e.p2pId),
								b.remoteStreams[e.getId()] === e && delete b.remoteStreams[e.getId()],
								b.remoteStreams[e.getId()] === e && delete b.remoteStreams[e.getId()],
								e.pc &&
						...
						(b.unsubscribe = function(e, t, n) {
							if ("object" !== re()(e) || null === e)
								return (
									r.default.error("[".concat(b.clientId, "] Invalid remote stream")),
									void T(n, x.INVALID_REMOTE_STREAM)
								);
							if (b.state !== h)
								return (
									r.default.error("[".concat(b.clientId, "] User is not in the session")),
									void T(n, x.INVALID_OPERATION)
								);
							if (
								(null != b.timers[e.getId()] &&
									(clearInterval(b.timers[e.getId()]), clearInterval(b.timers[e.getId()] + "audio")),
								...
								b.makeRequest({
									...
									b.p2ps.delete(e.p2pId),
									r.default.info("[".concat(b.clientId, "] Unsubscribe stream success")),
									t && t();
						...
						(b.renewToken = function(e, t, n) {
							e
								? b.key
									? b.state !== h
										? (r.default.debug(
												"[".concat(b.clientId, "] Client is not connected. Trying to rejoin")
										  ),
										  (b.key = e),
										  b.rejoin(),
										  t && t())
									...
									: (r.default.error(
											"[".concat(b.clientId, "] Client is previously joined without token")
									  ),
									  n && n(x.INVALID_PARAMETER))
								: (r.default.error("[".concat(b.clientId, "] Invalid Token ").concat(e)),
								  n && n(x.INVALID_PARAMETER));
						}),
						...
						(b.closeGateway = function() {
							r.default.debug("[".concat(b.clientId, "] close gateway")),
								(b.state = v),
								b.socket.close(),
								A();
						});
					var R = function() {
						r.default.debug("[".concat(b.clientId, "] Reconnect gateway")),
							(b.state = v),
							b.socket.close(),
							A(),
					...
					var C = function(e, t) {
							b.dispatchEvent(u({ type: "rejoin-start" })),
								(e =
									e ||
									function(e) {
										r.default.info(
								...
								(t =
									t ||
									function(e) {
										r.default.error("[".concat(b.clientId, "] Re-join to channel failed "), e),
											b.dispatchEvent(d({ type: "error", reason: e }));
									}),
								b.key
									? (++b.rejoinAttempt, b.join(b.joinInfo, b.key, e, t))
									: r.default.error(
											"[".concat(b.clientId, "] Connection recover failed [Invalid channel key]")
									  );
						},
						O = function(e, t, i) {
							if (((b.onConnect = t), b.socket)) {
								if ((b.dispatchEvent({ type: "reconnect" }), "retry" === b.reconnectMode))
									r.default.debug("[".concat(b.clientId, "] Retry current gateway")),
										b.socket.reconnect();
								else if ("tryNext" === b.reconnectMode)
									r.default.debug("[".concat(b.clientId, "] Try next gateway")),
										b.socket.connectNext();
								else if ("recover" === b.reconnectMode) {
									r.default.debug("[".concat(b.clientId, "] Recover gateway")),
										r.default.debug(
											"[".concat(
												b.clientId,
									...
									ze(b.joinInfo, function(e) {
										r.default.debug(
											"["
												...
												.concat(s, " get gateway list success")
										),
								...
								(c = e.gatewayAddr),
									...
									b.socket.on("on_uplink_stats", function(e) {
										var t = {};
										for (var n in e) t[it(n)] = e[n];
										(b.OutgoingAvailableBandwidth = t.uplink_available_bandwidth),
											b.localStreams[b.uid] && (b.localStreams[b.uid].uplinkStats = t);
									}),
									...
									b.socket.on("disconnect", function(e) {
										if (
											(r.default.debug("[".concat(b.clientId, "] Receive disconnect message")),
											b.state !== v)
										) {
											b.state = v;
											var t = d({
												...
												if (
													(r.default.error(
														"["
															...
															.concat(JSON.stringify(e), "], attempt to recover [#")
															.concat(b.attemps, "] after ")
															.concat(o / 1e3, " seconds")
													),
													b.hasInvokeLeave)
												)
													return (
												...
												setTimeout(function() {
													b.attemps++,
														...
														Date.now() - b.inChannelInfo.joinAt >
															Object(a.getParameter)("TICKET_RENEW_TIMEOUT")
															? (r.default.debug("Recovering to renew ticket"), R())
															: C();
												}, o);
											}
										}
									...
									b.socket.on("on_add_audio_stream", function(e) {
										if (
											(r.default.info(
												"["
													.concat(b.clientId, "] Newly added audio stream with uid ")
													.concat(e.uid)
											),
											b.joinInfo.stringUid &&
												"string" != typeof e.uid &&
												r.default.error("StringUID is Mixed with UintUID"),
									...
									b.socket.on("on_add_video_stream", function(e) {
										if (
											(r.default.info(
												"["
													.concat(b.clientId, "] Newly added remote stream with uid ")
													.concat(e.uid, ".")
											),
											b.joinInfo.stringUid &&
												"string" != typeof e.uid &&
											...
											if (void 0 !== a.stream) {
												if (
													...
													r.default.info(
														"["
															.concat(b.clientId, "] Stream changed: enable video ")
															.concat(e.uid)
													),
													t.isPlaying())
												) {
												...
												(b.remoteStreams[e.uid] = t),
													r.default.info(
														"["
															.concat(b.clientId, "] Stream changed: modify video ")
															.concat(e.uid)
													);
											}
										}
									...
									b.socket.on("on_remove_stream", function(e) {
										...
										if (t) {
											...
											b.dispatchEvent(n),
												t.close(),
												void 0 !== t.pc &&
													(t.pc.close(), (t.pc = void 0), b.p2ps.delete(t.p2pId));
									...
									b.socket.on("mute_audio", function(e) {
										r.default.info("[".concat(b.clientId, "] rcv peer mute audio: ").concat(e.uid)),
										...
										n
											? ((n.peerMuteAudio = !0),
											  ...
											  b.dispatchEvent(t))
											: r.default.debug("Ignoring event ".concat(e.type), e);
									}),
									b.socket.on("unmute_audio", function(e) {
										r.default.info(
											"[".concat(b.clientId, "] rcv peer unmute audio: ").concat(e.uid)
										),
											(b.remoteMuteState[e.uid] = b.remoteMuteState[e.uid] || {
												audio: !1,
												video: !1
									...
									b.socket.on("mute_video", function(e) {
										r.default.info("[".concat(b.clientId, "] rcv peer mute video: ").concat(e.uid)),
											(b.remoteMuteState[e.uid] = b.remoteMuteState[e.uid] || {
												audio: !1,
												video: !1
											}),
									...
									b.socket.on("unmute_video", function(e) {
										r.default.info(
											"[".concat(b.clientId, "] rcv peer unmute video: ").concat(e.uid)
										),
											(b.remoteMuteState[e.uid] = b.remoteMuteState[e.uid] || {
												audio: !1,
												video: !1
									...
									b.socket.on("on_p2p_lost", function(e) {
										...
										(t = b.localStreams[e.uid] || b.remoteStreams[e.uid])
											...
											: r.default.warning("P2PLost Stream Not found", e),
											r.default.debug("[".concat(b.clientId, "] p2plost:"), e.p2pid),
									...
									b.socket.on("on_token_privilege_will_expire", function(e) {
										r.default.debug(
											"[".concat(b.clientId, "] Received Message onTokenPrivilegeWillExpire")
										),
											b.dispatchEvent(
												u({
									...
									(b._doWithAction = function(e, t, n) {
										"tryNext" === e
											? (function(e, t) {
													r.default.debug("[".concat(b.clientId, "] Connect next gateway")),
														(b.state = v),
														b.socket.close(),
														A(),
														(b.reconnectMode = "tryNext"),
											...
											: "quit" === e
											? (r.default.debug("[".concat(b.clientId, "] quit gateway")),
											  (b.state = v),
											  b.socket.close(),
											  A())
											: "recover" === e && R();
									...
									b.socket.on("on_notification", function(e) {
										if (
											(r.default.debug("[".concat(b.clientId, "] Receive notification: "), e),
									...
									b.socket.on("on_user_offline", function(e) {
										...
										if (
											...
											r.default.info(
												"[".concat(b.clientId, "] closing stream on peer leave"),
												e.uid
											);
											...
											n.close(),
												...
												void 0 !== n.pc &&
													(n.pc.close(), (n.pc = void 0), b.p2ps.delete(n.p2pId));
										}
						...
						N = function(e, t) {
							if (void 0 !== b.socket)
								try {
									...
									r.default.error(
										"[".concat(b.clientId, "] Error in sendSimpleSdp [").concat(e, "]")
									);
								}
				...
				rt = {
					...
					unregister: function(e) {
						...
						if (this._gatewayClients[n] && this._gatewayClients[n][t]) {
							...
							return (
								r.default.debug("[".concat(e.clientId, "] unregister client "), e.uid),
				...
				ut = function(e) {
					...
					return (
						...
						(t.checkVideoDecode = function(e) {
							return (
								!e || 0 === parseInt(e.videoRecvBytesDelta) || 0 !== parseInt(e.googFrameRateDecoded)
							);
						}),
													...
													e.abrupt(
														...
														new Promise(function(e, t) {
															...
															l.open("POST", n, !0),
																...
																l.setRequestHeader("X-Packet-Service-Type", "0"),
																l.setRequestHeader("X-Packet-URI", "61"),
																(l.onload = function() {
																	if (!u) {
																		var n = null,
																			i = null;
																...
																(l.ontimeout = function(e) {
																	r.default.error("AP_REUEST_TIMEOUT", n, e),
																		u || ((u = !0), t("AP_REUEST_TIMEOUT"));
																}),
																d && (l.timeout = d),
																l.send(
																	JSON.stringify({
										...
										switch ((e.prev = e.next)) {
											case 0:
												(n = t.serviceName),
													...
													(s = t.cname),
													(c = null),
													(e.t0 = Ue.a.keys(Object(a.getParameter)("UAP_AP")));
											case 3:
												if ((e.t1 = e.t0()).done) {
													e.next = 34;
													break;
												...
												return (
													(d = e.t1.value),
													(u = "https://".concat(
														Object(a.getParameter)("UAP_AP")[d],
														"/api/v1?action=uap"
													)),
													(l = void 0),
													(e.prev = 7),
														...
														function(e) {
															for (;;)
																switch ((e.prev = e.next)) {
																	...
																	case 8:
																		return (
																			((o = e.sent).workerToken = l.workerToken),
																			e.abrupt("return", {
																				v: o
																			})
																		);
				...
				Rt = function(e) {
					...
					return (
											...
											for (;;)
												switch ((e.prev = e.next)) {
													case 0:
														...
														return (
															r.default.debug(
																"Ignored UapConnection.connect: ".concat(c.status)
															),
															e.abrupt("return")
														);
													case 4:
														(c.connection = n),
															...
															n.addEventListener("message", function(e) {
																if (e.data) {
																	...
																	if (t.requestId)
																		for (
																			var n = c.requests.length - 1;
																			n >= 0;
																			n--
																		) {
																			var i = c.requests[n];
																			if (i.reqData.requestId === t.requestId) {
																				c.requests.splice(n, 1),
								...
								return Ue.a.wrap(
									function(e) {
										for (;;)
											switch ((e.prev = e.next)) {
												case 0:
													for (t in ((c.status = pt),
													clearInterval(c.pingpongTimer),
													(c.pingpongTimer = null),
													c.requests))
														c.requests[t].promises.reject("DISCONNECTED");
													return (
														(c.requests = []),
														null,
														c.connection && (c.connection.close(), (c.connection = null)),
														(c.status = ft),
											...
											for (;;)
												switch ((e.prev = e.next)) {
													...
													case 11:
														...
														throw ((o = "WEBSOCKET_DISCONNECTING"),
														r.default.error(o),
														new Error(o));
													case 17:
														...
														throw ((s = "WEBSOCKET_DISCONNECTED"),
														r.default.error(s),
														new Error(s));
													case 23:
														return e.abrupt(
						...
						(c._flush = function() {
							c.connection &&
								c.status === mt &&
								c.requests.forEach(function(e) {
									e.sentTs ||
										((e.sentTs = Date.now()),
										e.reqData.clientRequest &&
											(e.reqData.clientRequest.workerToken = c.connection.workerToken),
										c.connection.send(JSON.stringify(e.reqData)));
								});
						}),
						(c.startPingpong = function() {
							clearInterval(c.pingpongTimer),
								(c.pingpongTimer = setInterval(
									Fe()(
										Ue.a.mark(function e() {
											return Ue.a.wrap(
												function(e) {
			...
			var Ct = function(e) {
					var t = e;
					if (Object(a.getParameter)("LIVESTREAMING_ALIGN"))
						switch (e) {
							case 200:
								t = T;
								break;
				...
				Nt = function(e) {
					...
					(t.turnServer = {
						...
						(t.mode = e.mode),
						(t.codec = e.codec),
						(t.clientId = Object(te.b)().slice(0, 5)),
						(t.uintUid = null);
					e = S()({}, e);
					return (
						(t.aespassword = null),
						...
						(t.setClientRole = function(n, i) {
							...
							t.gatewayClient && t.gatewayClient.state === ot.CONNECTED
								? ("audience" === n &&
						...
						(t.renewToken = function(n, i, a) {
							...
							return t.gatewayClient
								? t.key
									...
									: (r.default.error(
											"[".concat(t.clientId, "] renewToken should not be called before user join")
									  ),
									  s(x.INVALID_OPERATION))
								: (r.default.error(
										"[".concat(t.clientId, "] renewToken Failed. GatewayClient not Exist")
								  ),
								  s(x.INVALID_OPERATION));
						}),
						...
						(t.init = function(n, i, a) {
							...
							ce(n),
								Object(f.isChromeKernel)() && Object(f.getChromeKernelVersion)() <= 48
									? a
										? s(x.BAD_ENVIRONMENT)
										: Object(te.e)()
									: (r.default.info(
											"["
												.concat(t.clientId, "] Initializing AgoraRTC client, appId: ")
												.concat(n, ".")
									  ),
									  (e.appId = n),
									  (e.sessionId = Object(te.b)()),
									  s());
						}),
						...
						(t.setProxyServer = function(n) {
							...
							ce(n, "proxyServer"),
								(t.proxyServer = n),
								o.b.setProxyServer(n),
								r.default.setProxyServer(n),
								i();
						}),
						...
						(t.setEncryptionMode = function(n) {
							...
							if ((ce(n, "encryptionMode"), -1 === Ne.indexOf(n)))
								throw new Error(
						...
						(t.enableDualStream = function(n, i) {
							...
							return "iOS" === Object(f.getBrowserOS)()
								? (o.b.streamSwitch(e.sessionId, {
								  ...
								  a(x.IOS_NOT_SUPPORT))
								: Object(f.isWeChatBrowser)()
								? (o.b.streamSwitch(e.sessionId, {
										lts: new Date().getTime(),
										isdual: !0,
										succ: !1
								  }),
								  a(x.WECHAT_NOT_SUPPORT))
								: (o.b.streamSwitch(e.sessionId, {
										lts: new Date().getTime(),
										isdual: !0,
										succ: !0
								  ...
								  void (0 === t.highStreamState
										? t._publishLowStream(
												...
												function(e) {
													r.default.warning("[".concat(t.clientId, "]"), e),
														a(x.ENABLE_DUALSTREAM_FAILED);
												}
										  )
										: 1 === t.highStreamState
										? a(x.STILL_ON_PUBLISHING)
										: a(null)));
						}),
						...
						(t._createLowStream = function(e, n) {
							if (t.highStream && t.highStream.stream) {
								...
								if (((i.streamID += 1), (i.audio = !1), i.video)) {
									...
									o
										? ie.getVideoCameraIdByLabel(
												o.label,
												function(o) {
													i.cameraId = o;
													var s = new Re(i);
													if (
														((s.streamId = t.highStream.getId() + 1), t.lowStreamParameter)
													) {
														...
														if (
															...
															Object(f.isSafari)() || Object(f.isOpera)())
														) {
															r.default.debug(
																"[".concat(t.clientId, "] Shimming lowStreamParameter")
															);
										...
										: n && n(x.HIGH_STREAM_NOT_VIDEO_TRACE);
						...
						(t._publishLowStream = function(e, n) {
							return 2 !== t.lowStreamState
								? n && n(x.LOW_STREAM_ALREADY_PUBLISHED)
								: t.highStream && t.highStream.hasScreen()
								? n && n(x.SHARING_SCREEN_NOT_SUPPORT)
											...
											t.gatewayClient.publish(
												...
												function(e) {
													1 === t.lowStreamState && (t.lowStreamState = 2),
														r.default.debug(
															"[".concat(t.clientId, "] publish low stream failed")
														),
														n && n(e);
												}
											);
						...
						(t._unpublishLowStream = function(e, n) {
							...
							t.lowStream &&
								(t.gatewayClient.unpublish(
									...
									function() {},
									function(e) {
										r.default.debug("[".concat(t.clientId, "] unpublish low stream failed")),
											n && n(e);
									}
								),
								t.lowStream.close(),
						...
						(t.join = function(n, i, a, s, c) {
							...
							if (n && !me(n))
								return (
									r.default.warning("[".concat(t.clientId, "] Param channelKey should be string")),
									u(x.INVALID_PARAMETER)
								);
							if (
								!Ie((d = i)) ||
								!/^[a-zA-Z0-9 \!\#\$\%\&\(\)\+\-\:\;\<\=\.\>\?\@\[\]\^\_\{\}\|\~\,]{1,64}$/.test(d)
							)
								return (
									r.default.error("Invalid Channel Name ".concat(i)),
									r.default.warning(
										"[".concat(
											t.clientId,
							...
							if ("string" == typeof i && "" === i)
								return (
									r.default.warning("[".concat(t.clientId, "] Param channel should not be empty")),
									u(x.INVALID_PARAMETER)
								);
							if (a && !Object(te.c)(a) && !le(a, 1, 255))
								return (
									r.default.error("Invalid UID ".concat(a, " ").concat(re()(a))),
									r.default.warning(
										"[".concat(
											t.clientId,
							...
							if ("string" == typeof a && 0 == a.length)
								return (
									r.default.warning("[".concat(t.clientId, "] String uid should not be empty")),
									u(x.INVALID_PARAMETER)
								);
							if ("string" == typeof a && a.length > 256)
								return (
									r.default.warning(
										"[".concat(t.clientId, "] Length of string uid should be less than 255")
									),
									u(x.INVALID_PARAMETER)
								);
							(t.highStream = null),
							...
							if (
								("string" == typeof a &&
									((l.stringUid = a),
									t.uintUid ? ((l.uid = t.uintUid), delete t.uintUid) : (l.uid = 0)),
								t.aespassword &&
									"none" !== t.aesmode &&
									S()(l, {
								...
								return (
									r.default.error(
										"[".concat(t.clientId, "] Client already in connecting/connected state")
									),
									u(x.INVALID_OPERATION),
									void o.b.joinGateway(e.sessionId, {
										lts: Date.now(),
										succ: !1,
										ec: x.INVALID_OPERATION,
										addr: null
							...
							var p = function(a, o) {
								r.default.info("[".concat(t.clientId, "] Joining channel: ").concat(i)),
									t.gatewayClient.dispatchEvent({
							...
							l.stringUid && !l.uid
								? (t.userAccountReq && !t.userAccountReq.isFinished() && t.userAccountReq.cancel(),
								  (t.userAccountReq = Xe(l, t.gatewayClient)),
								  t.userAccountReq
										.then(function(e) {
											r.default.debug(
						...
						(t.leave = function(n, i) {
								...
								c = o.b.reportApiInvoke(e.sessionId, {
									callback: function(e, a) {
										...
										(t.gatewayClient.reconnectingCS = !1),
											clearTimeout(((r = t.clientId), qe[r])),
											t._renewSession(),
							...
							r.default.info("[".concat(t.clientId, "] Leaving channel")),
								t.userAccountReq &&
								...
								setTimeout(function() {
									s ||
										(t.gatewayClient.socket &&
											(t.gatewayClient.socket.close(), (t.gatewayClient.socket = null)),
										(t.gatewayClient.state = ot.DISCONNECTED),
						...
						(t._renewSession = function() {
							var n = Object(te.b)();
							if (
								(r.default.debug("renewSession ".concat(e.sessionId, " => ").concat(n)),
								(e.sessionId = n),
								t.joinInfo && (t.joinInfo.sid = n),
								t.gatewayClient &&
									(t.gatewayClient.joinInfo && (t.gatewayClient.joinInfo.sid = n),
						...
						(t._publish = function(n, i, o) {
							if (2 !== t.highStreamState)
								return (
									r.default.warning(
										"["
											.concat(t.clientId, "] Can't publish stream when stream already publish ")
											.concat(n.getId())
									),
									o && o(x.STREAM_ALREADY_PUBLISHED)
								);
							if (
								"auto" === t.turnServer.mode &&
								Object(a.getParameter)("FORCE_TURN") &&
								!Object(a.getParameter)("TURN_ENABLE_TCP") &&
								!Object(a.getParameter)("TURN_ENABLE_UDP")
							)
								throw new Error("force TURN With No TURN Configuration");
							r.default.info("[".concat(t.clientId, "] Publishing stream, uid ").concat(n.getId())),
								(t.highStream = n),
								(t.highStreamState = 1),
								...
								t.gatewayClient.publish(
									...
									function() {
										(n.sid = e.sessionId),
											(t.highStreamState = 0),
											r.default.info(
												"[".concat(t.clientId, "] Publish success, uid: ").concat(n.getId())
											),
							...
							"audience" === t.gatewayClient.role && "live" === t.mode
						...
						(t._unpublish = function(e, n, i) {
							if (0 !== t.highStreamState)
								return (
									r.default.warning(
										"[".concat(t.clientId, "] Can't unpublish stream when stream not publish")
									),
									i && i(x.STREAM_NOT_YET_PUBLISHED)
								);
									...
									t.gatewayClient.unpublish(
										...
										function() {
											(t.highStreamState = 2),
												r.default.info(
													"["
														.concat(t.clientId, "] Unpublish stream success, uid: ")
														.concat(e.getId())
												),
												n && n();
										},
							...
							"host" === t.gatewayClient.role && "live" === t.mode
						...
						(t.subscribe = function(n, i, a) {
							...
							"function" == typeof i && ((a = i), (i = null)),
								...
								_e(i) ||
									(se(i, "options"),
									_e(i.video) || ue(i.video, "options.video"),
									_e(i.audio) || ue(i.audio, "options.audio"));
							...
							if (!_e(i)) {
								...
								if (
									(!_e(i.video) && !fe(i.video)) ||
									(!_e(i.audio) && !fe(i.audio)) ||
									(!1 === i.audio && !1 === i.video)
								) {
						...
						(t.unsubscribe = function(n, i) {
							...
							r.default.info("[".concat(t.clientId, "] Unsubscribe stream, uid: ").concat(n.getId())),
						...
						(t.enableAudioVolumeIndicator = function(n, i) {
							...
							(n = n || 2e3),
								de((i = i || 3), "smooth", 1, 100),
								de(n, "interval", 50, 1e5),
								...
								r.default.info(
									"["
										.concat(t.clientId, "] enableAudioVolumeIndicator interval ")
										.concat(n, " smooth ")
										.concat(i)
								),
						...
						(t.on = function(e, n) {
							t.gatewayClient.on(e, n),
								...
								t.listenerLoggerTimer
									...
									: r.default.info("[".concat(t.clientId, "] Adding event handler on ").concat(e)),
						...
						(t.off = function(e, n) {
							r.default.info("remove event handler from [".concat(e, "]")),
							...
							return (
								...
								(t.getRemoteAudioStats = function(e) {
									...
									for (var i in t.remoteStats) {
										...
										ne(a, "End2EndDelay", r.peer_delay && r.peer_delay.audio_delay),
											ne(a, "TransportDelay", r.peer_delay && r.peer_delay.e2e_delay),
											ne(
												a,
												"PacketLossRate",
												r.peer_delay && r.peer_delay.e2e_audio_lost_ratio_400ms
											),
											ne(a, "RecvLevel", r.audioStats && r.audioStats.audioOutputLevel),
											ne(a, "RecvBitrate", r.audioRecvBitrate),
											ne(a, "CodecType", r.audioStats && r.audioStats.googCodecName),
											ne(a, "MuteState", r.audioDisabled),
											ne(a, "TotalFreezeTime", r.audioStats && r.audioStats.audioTotalFreezeTime),
											ne(
												a,
												"TotalPlayDuration",
								...
								(t.getLocalAudioStats = function(e) {
									...
									for (var i in t.localStats) {
										var a = {},
											r = t.localStats[i];
										ne(a, "RecordingLevel", r.audioStats && r.audioStats.audioInputLevel),
											ne(a, "SendLevel", r.audioStats && r.audioStats.totalAudioEnergy),
											ne(a, "SamplingRate", r.audioStats && r.audioStats.totalSamplesDuration),
											ne(a, "SendBitrate", r.audioSendBitrate),
											ne(a, "CodecType", r.audioStats && r.audioStats.googCodecName),
											ne(a, "MuteState", r.audioDisabled);
										var o = t.gatewayClient.localStreams[i];
										o && o.isPlaying() && ne(a, "MuteState", o.userMuteAudio ? "1" : "0"),
											(n[i] = a);
									}
									e && e(n);
								}),
								(t.getRemoteVideoStats = function(e) {
									...
									for (var i in t.remoteStats) {
										var a = {},
											r = t.remoteStats[i];
										ne(a, "End2EndDelay", r.peer_delay && r.peer_delay.video_delay),
											ne(a, "TransportDelay", r.peer_delay && r.peer_delay.e2e_delay),
											ne(
												a,
												"PacketLossRate",
											...
											ne(a, "RecvBitrate", r.videoRecvBitrate),
											ne(
												a,
												"RecvResolutionWidth",
											...
											ne(a, "RenderFrameRate", r.videoStats && r.videoStats.googFrameRateOutput),
											ne(a, "MuteState", r.videoDisabled),
											ne(a, "TotalFreezeTime", r.videoStats && r.videoStats.videoTotalFreezeTime),
											ne(
												a,
												"TotalPlayDuration",
								...
								(t.getLocalVideoStats = function(e) {
									...
									for (var i in t.localStats) {
										var a = {},
											r = t.localStats[i];
										ne(a, "TargetSendBitrate", r.videoTargetSendBitrate),
											ne(a, "SendFrameRate", r.videoStats && r.videoStats.googFrameRateSent),
											ne(a, "SendBitrate", r.videoSendBitrate),
											ne(
												a,
												"SendResolutionWidth",
											...
											ne(a, "EncodeDelay", r.videoStats && r.videoStats.googAvgEncodeMs),
											ne(a, "MuteState", r.videoDisabled),
											ne(a, "TotalFreezeTime", r.videoStats && r.videoStats.videoTotalFreezeTime),
											ne(a, "TotalDuration", r.videoStats && r.videoStats.videoTotalPlayDuration),
											ne(a, "CaptureFrameRate", r.videoStats && r.videoStats.googFrameRateSent),
											r.videoStats &&
								...
								(t.getRemoteVideoQualityStats = function(e) {
									...
									for (var i in t.remoteStats) {
										var a = {},
											r = t.remoteStats[i];
										ne(a, "videoReceiveDelay", r.videoStats && r.videoStats.googCurrentDelayMs),
											ne(a, "VideoFreezeRate", r.videoStats && r.videoStats.videoFreezeRate),
											ne(a, "FirstFrameTime", r.firstFrameTime),
											(n[i] = a);
									}
									e && e(n);
								}),
								(t.getRemoteAudioQualityStats = function(e) {
									...
									for (var i in t.remoteStats) {
										var a = {},
											r = t.remoteStats[i];
										ne(a, "audioReceiveDelay", r.audioStats && r.audioStats.googCurrentDelayMs),
											ne(a, "AudioFreezeRate", r.videoStats && r.videoStats.videoFreezeRate),
											(n[i] = a);
									}
									e && e(n);
								}),
										...
										try {
											for (var d, u = r[Symbol.iterator](); !(o = (d = u.next()).done); o = !0) {
												...
												l.downlink_estimate_bandwidth &&
													(i[l.peer_uid] = l.downlink_estimate_bandwidth / 1e3 + "");
											}
										} catch (e) {
											(s = !0), (c = e);
										} finally {
								...
								(t.getSessionStats = function(e) {
									...
									t.gatewayClient.socket &&
										t.gatewayClient.socket.state === t.gatewayClient.CONNECTED &&
										((l += a.getSendBytes()), (p += a.getRecvBytes()));
									var f = 1;
									i.peer_delay && ((f = i.peer_delay.length), (f += 1)),
										ne(n, "Duration", a.getDuration()),
										ne(n, "UserCount", f),
										ne(n, "SendBytes", l),
										ne(n, "RecvBytes", p),
										ne(n, "SendBitrate", (8 * d) / 1e3),
										ne(n, "RecvBitrate", (8 * u) / 1e3),
										e && e(n);
								}),
								(t.isLocalVideoFreeze = function(e, t) {
									var n = 0,
										i = 0;
									if (!e || !t) return !1;
									if (Object(f.isChrome)() || Object(f.isOpera)())
										(n = e.googFrameRateInput), (i = e.googFrameRateSent);
									else if (Object(f.isSafari)())
								...
								(t.isRemoteVideoFreeze = function(e, t) {
									...
									return (
										(n > 5 && n < 10 && i < 3) || (n > 10 && n < 20 && i < 4) || (n > 20 && i < 5)
									);
								}),
								(t.isAudioFreeze = function(e) {
									if (Object(f.isChrome)() && e) {
										if (e.googDecodingPLC && e.googDecodingPLCCNG && e.googDecodingCTN)
											return (
												(parseInt(e.googDecodingPLC) + parseInt(e.googDecodingPLCCNG)) /
										...
										return (
											parseInt(e.packetsLost) /
												(parseInt(e.packetsLost) + parseInt(e.packetsReceived)) >
											0.2
										);
									return !1;
								}),
								(t.isAudioDecodeFailed = function(e) {
									return !!(
										(Object(f.isChrome)() || Object(f.isOpera)()) &&
										e &&
								...
								(t.getStatsTimer = setInterval(function() {
									...
									Object.keys(t.gatewayClient.remoteStreams).forEach(function(a) {
										...
										(i[a] = s),
											...
											o
												? ((s.audioTotalPlayDuration = o.audioTotalPlayDuration + 1),
										...
										c && (s.peer_delay = c),
											r &&
												(r.isPlaying() &&
													((s.audioDisabled = r.userMuteAudio || r.peerMuteAudio ? "1" : "0"),
													...
													r.pc.getStats(function(e) {
														if (
															...
															t.isAudioFreeze(s.audioStats) &&
																...
																(s.audioTotalFreezeTime++, (s.isAudioFreeze = !0)),
														...
														if (o && o.videoStats && s.videoStats) {
															...
															(s.videoStats.videoRecvBytesDelta = c),
																...
																t.isRemoteVideoFreeze(s.videoStats, o.videoStats) &&
																	(s.videoTotalFreezeTime++, (s.isVideoFreeze = !0)),
									...
									var a = {};
									if (
										(Object.keys(t.gatewayClient.localStreams).forEach(function(e) {
											var i = t.gatewayClient.localStreams[e],
												r = t.localStats[e],
												o = { id: e, updatedAt: n };
											(a[e] = o),
												r
													? ((o.videoTotalPlayDuration = r.videoTotalPlayDuration + 1),
													  (o.videoTotalFreezeTime = r.videoTotalFreezeTime),
													  (o.isVideoFreeze = !1))
													: ((o.videoTotalPlayDuration = 1), (o.videoTotalFreezeTime = 0)),
												i &&
													(i.isPlaying() &&
														((o.audioDisabled = i.userMuteAudio ? "1" : "0"),
														(o.videoDisabled = i.userMuteVideo ? "1" : "0")),
													i.video && i.attributes.maxVideoBW
														? (o.videoTargetSendBitrate = i.attributes.maxVideoBW)
														: i.video &&
														  i.screenAttributes &&
														  (o.videoTargetSendBitrate = i.screenAttributes.maxVideoBW),
													i.pc &&
														...
														i.pc.getStats(function(e) {
																...
																(o.audioStats = e.find(function(e) {
																	return (
																		...
																		(e.id.indexOf("_send") > -1 ||
																			e.id.toLowerCase().indexOf("outbound") > -1)
																	);
																})),
															...
															if (o.videoStats && r && r.videoStats) {
																...
																(o.videoStats.videoSendBytesDelta = s),
																	...
																	t.isLocalVideoFreeze(o.videoStats, r.videoStats) &&
										...
										(t.localStats = a),
										(t.session.HTTPSendBytesDelta = Object(Le.b)() - t.session.HTTPSendBytes),
										(t.session.HTTPSendBytes = Object(Le.b)()),
										(t.session.HTTPRecvBytesDelta = Object(Le.a)() - t.session.HTTPRecvBytes),
										(t.session.HTTPRecvBytes = Object(Le.a)()),
										t.gatewayClient.socket &&
											t.gatewayClient.socket.state === t.gatewayClient.CONNECTED)
									) {
							...
							return (
								...
								t.client.gatewayClient &&
									t.client.gatewayClient.on("config-distribute", function(n) {
										...
										if (s) {
											_e(s.uploadLog) ||
												(Object(a.setParameter)("UPLOAD_LOG", s.uploadLog),
												...
												_e(s.streamFallbackOption) ||
													(t.client.gatewayClient &&
														t.client.gatewayClient.on("stream-subscribed", function(e) {
															var n = e.stream;
															n
																? (t.client.gatewayClient.setStreamFallbackOption(
																		n,
																		s.streamFallbackOption
																  ),
																  o.b.reportApiInvoke(i.sid, {
																		name: "_configDistribute",
																		options: {
											...
											try {
												r.default.debug(
													"["
														.concat(e.clientId, "] setParameter in distribution: ")
												...
												r.default.debug(
													"["
														.concat(e.clientId, "] setParameter in distribution failed: ")
														.concat(JSON.stringify(s))
												);
											}
										}
							...
							(e.liveStreaming = s()),
														...
														switch ((t.prev = t.next)) {
															...
															case 5:
																e.liveStreaming.connections.hasOwnProperty(i) &&
																	(a = e.liveStreaming.connections[i]) &&
																	(r.default.info(
																		"LiveStreaming closing connection ".concat(i)
																	),
																	a.disconnect(),
															...
															case 13:
																...
																if (
																	((s = e.liveStreaming.pushStates[o]),
														...
														switch ((n.prev = n.next)) {
															case 0:
																return (
																	...
																	r.default.debug(
																		"startLiveStreaming ".concat(i, ", ").concat(a)
																	),
																	S()(o.clientRequest, e.liveStreaming.startOptions, {
																		ts: Date.now(),
																		url: i,
																	...
																	a
																		? (e.liveStreaming.connections.mix_streaming ||
																		  ...
																		  (o.clientRequest.transcodingConfig = JSON.parse(
																				JSON.stringify(
																					e.liveStreaming.transcodingConfig
																				)
																		  )),
																		...
																		: ("vp8" === t.codec &&
																		  ...
																		  e.liveStreaming.connections.raw_streaming ||
																				e.liveStreaming.connect(
																					"raw_streaming"
																				),
																		  (s =
															...
															case 10:
																(c = n.sent),
																	...
																	(d.status = c && c.code),
																	(d.url =
																		c && c.serverResponse && c.serverResponse.url),
								...
								(e.setLiveTranscoding = function(n, i) {
									...
									if (
										...
										_e(r) || de(r, "width"),
										_e(s) || de(s, "height"),
										_e(c) || de(c, "videoBitrate", 1, 1e6),
										_e(d) || de(d, "videoFramerate"),
										_e(u) || ue(u, "lowLatency"),
										_e(l) || oe(l, "audioSampleRate", [32e3, 44100, 48e3]),
										_e(p) || de(p, "audioBitrate", 1, 128),
										_e(f) || oe(f, "audioChannels", [1, 2, 3, 4, 5]),
										_e(m) || de(m, "videoGop"),
										_e(g) || oe(g, "videoCodecProfile", [66, 77, 100]),
										_e(v) || de(v, "userCount", 0, 17),
										_e(S) || de(S, "backgroundColor", 0, 16777215),
										!_e(I))
									) {
										if (!he(I))
										...
										I.map(function(e, t) {
											if (!_e(e.uid) && !At(e.uid) && !isValidString(e.uid, 1, 255))
												throw new Error(
													"[String uid] Length of the string: [1,255]. ASCII characters only. [Number uid] The value range is [0,10000]"
												);
											if (
												(_e(e.x) || de(e.x, "transcodingUser[".concat(t, "].x"), 0, 1e4),
												_e(e.y) || de(e.y, "transcodingUser[".concat(t, "].y"), 0, 1e4),
												_e(e.width) ||
													de(e.width, "transcodingUser[".concat(t, "].width"), 0, 1e4),
												_e(e.height) ||
													de(e.height, "transcodingUser[".concat(t, "].height"), 0, 1e4),
												_e(e.zOrder) ||
													de(e.zOrder, "transcodingUser[".concat(t, "].zOrder"), 0, 100),
												!(_e(e.alpha) || (Se(e.alpha) && e.alpha <= 1 && e.alpha >= 0)))
											)
												throw new Error(
									...
									if (
										((n = JSON.parse(JSON.stringify(n))).transcodingUsers &&
											((n.userConfigs = n.transcodingUsers), delete n.transcodingUsers),
										e.joinInfo.stringUid && n.userConfigs && n.userConfigs.length)
									) {
										var _ = [];
										n.userConfigs.forEach(function(t) {
											_.push(
												Xe(e.joinInfo, e.gatewayClient, t.uid).then(function(e) {
													t.uid = e.uid;
												})
											);
										});
								...
								(e.addInjectStreamUrl = function(i, a) {
									ce(i, "url", 1, 255),
										se(a, "config"),
										!_e(a && a.width) && de(a.width, "config.width", 0, 1e4),
										!_e(a && a.height) && de(a.height, "config.height", 0, 1e4),
										!_e(a && a.videoGop) && de(a.videoGop, "config.videoGop", 1, 1e4),
										!_e(a && a.videoFramerate) &&
											de(a.videoFramerate, "config.videoFramerate", 1, 1e4),
										!_e(a && a.videoBitrate) && de(a.videoBitrate, "config.videoBitrate", 1, 1e4),
										!_e(a && a.audioSampleRate) &&
											oe(a.audioSampleRate, "config.audioSampleRate", [32e3, 44100, 48e3]),
										!_e(a && a.audioBitrate) && de(a.audioBitrate, "config.audioBitrate", 1, 1e4),
										!_e(a && a.audioChannels) && de(a.audioChannels, "config.audioChannels", 1, 2);
														...
														switch ((n.prev = n.next)) {
															case 0:
																return (
																	...
																	e.liveStreaming.connections.inject_streaming ||
													...
													for (;;)
														switch ((n.prev = n.next)) {
															case 0:
																return (
																	ce(i, "url", 1, 255),
																	(a = o.b.reportApiInvoke(t.sessionId, {
						...
						_e(e.turnServer) || t.setTurnServer(e.turnServer),
						_e(e.proxyServer) || t.setProxyServer(e.proxyServer),
						...
						t.gatewayClient.on("onMultiIP", function(e) {
							t.gatewayClient.closeGateway(),
								...
								(t.gatewayClient.state = ot.CONNECTING);
							var n = function(e) {
								r.default.info("[".concat(t.clientId, "] Joining channel: ").concat(t.channel)),
									...
									t.onSuccess
										...
										: ((t.gatewayClient.joinInfo = S()({}, t.joinInfo)), t.gatewayClient.rejoin());
							};
						...
						t.gatewayClient.on("rejoin", function() {
							...
							if (
								(r.default.debug("[".concat(t.clientId, "] Client local stream preState: ").concat(e)),
								t.onSuccess)
							) {
								var n = t.onSuccess;
							...
							!t.highStream ||
								(0 !== e && 1 !== e) ||
								(r.default.info("[".concat(t.clientId, "] publish after rejoin")),
								(t.highStreamState = 2),
								(t.lowStreamState = 2),
						...
						t.gatewayClient.on("pubP2PLost", function(e) {
							r.default.debug(
								"["
									.concat(t.clientId, "] Start reconnect local peerConnection: ")
									...
									function() {
										t._publish(
											...
											function(e) {
												r.default.debug(
													"["
														.concat(t.clientId, "] Reconnect local peerConnection failed: ")
														.concat(e)
												),
													t.gatewayClient.dispatchEvent({
														type: "stream-reconnect-end",
						...
						t.gatewayClient.on("subP2PLost", function(e) {
							r.default.debug(
								"["
									.concat(t.clientId, "] Start reconnect remote peerConnection: ")
							...
							console.log("Re-subscribe stream", n, e.stream),
								t.gatewayClient.unsubscribe(
									...
									function(n) {
										r.default.debug(
											"[".concat(t.clientId, "] Reconnect remote peerConnection failed: "),
											n
										),
											t.gatewayClient.dispatchEvent({
												type: "stream-reconnect-end",
						...
						t.gatewayClient.on("streamTypeChange", function(n) {
							...
							t.gatewayClient.dispatchEvent(i),
								o.b.reportApiInvoke(e.sessionId, {
			...
			t.default = {
				...
				createClient: function(e) {
					...
					var n = (function(e) {
						return -1 === Ce.indexOf(e.mode)
							? x.INVALID_CLIENT_MODE
							: -1 === Oe.indexOf(e.codec)
							? x.INVALID_CLIENT_CODEC
					...
					if (n)
						...
						new Error(n));
					return (
						r.default.info("Creating client, MODE: ".concat(e.mode, " CODEC: ").concat(e.codec)),
						(function(e) {
							switch (e.mode) {
								case "interop":
								case "h264_interop":
				...
				createStream: function(e) {
					...
					var n = e.streamID,
						...
						f = e.mediaSource,
						m = e.audioProcessing;
					if (!_e(n) && !Object(te.c)(n) && !le(n, 1, 255))
						throw new Error(
					...
					if (
						...
						ue(a, "video"),
						_e(s) || ue(s, "screen"),
						_e(c) || ce(c, "cameraId", 0, 255, !1),
						_e(d) || oe(d, "facingMode", ["user", "environment", "left", "right"]),
						_e(u) || ce(u, "microphoneId", 0, 255, !1),
						_e(p) || ce(p, "extensionId"),
						_e(f) || oe(f, "mediaSource", ["screen", "application", "window"]),
						_e(l) || ue(l, "mirror"),
						!_e(m))
					) {
						var g = m.AGC,
				...
				checkSystemRequirements: function() {
					var e = o.b.reportApiInvoke(null, {
						...
						a = !!t && !!n && !!i,
						s = !1;
					r.default.debug(f.getBrowserInfo(), "isAPISupport:" + a),
