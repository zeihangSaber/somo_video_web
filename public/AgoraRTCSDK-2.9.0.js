...
!(function(e, t) {
  ...
  return (function(e) {
          ...
          return (
            (e.reportApiInvoke = function(e, n) {
              ...
              var y = setTimeout(function() {
                g._sendApiInvoke(
                  a()({}, h(), { error: "API_INVOKE_TIMEOUT", success: !1 })
                );
              }, l);
              return function(e, t) {
                if (
                  (clearTimeout(y),
                  ++S > 1 && (e = "EXECUTOR_INVOKE_".concat(S)),
                  e)
                )
                  return (
                    g._sendApiInvoke(
        ...
        d = function(e) {
          return (
            ...
            (this.getAudioLevel = function() {
              ...
              return (
                a.default.warning("can't find analyser in audioLevelHelper"), 0
              );
            }),
            this
          );
    ...
    function(e, t, n) {
      ...
      if (
        ...
        if (navigator.mozGetUserMedia && window.mozRTCPeerConnection) {
          ...
          if (
            ...
            var h = navigator.mediaDevices.enumerateDevices.bind(
              navigator.mediaDevices
            );
          ...
          if (
            ...
            if (Number(Object(r.getBrowserVersion)().split(".")[0]) < 46) {
              var y = navigator.mediaDevices.getUserMedia.bind(
                navigator.mediaDevices
              );
      ...
      p
        ? (b = p)
        : "undefined" != typeof window && (b = window.RTCPeerConnection);
    },
    function(e, t, n) {
      var i = n(19);
      e.exports = function(e) {
      ...
      var o = (function() {
        function e(e) {
          (this.candidate = null),
            ...
            (this.peerConnection.onicecandidate = this._onicecandidate.bind(
              this
            )),
            (this.peerConnection.oniceconnectionstatechange = this._oniceconnectionstatechange.bind(
              this
            )),
            ...
            switch (a.label) {
              ...
              case 1:
                try {
                  ...
                  return (
                    c.default.error("Failed to init RTCPeerConnection", e),
                    [2, Promise.reject(e)]
                  );
                }
                return n
              ...
              case 2:
                return e && e.stream
                  ...
                  : ((i = {
                    ...
                    (r = void 0),
                    (s.isSafari() || s.isFireFox() || s.isWeChatBrowser()) &&
                    n.addTransceiver
    ...
    function(e, t, n) {
      ...
      var g = new (function() {
              ...
              (e.state = e.states.INITING),
                navigator.getBattery
                  ? navigator
                      ...
                      .catch(function(e) {
                        r.default.debug("navigator.getBattery is disabled", e),
                          t && t();
                      })
        ...
        V = function(e) {
            ...
            (t.setAudioOutput = function(e, n, i) {
              ...
              return a
                ? a.setSinkId
                  ...
                  : (r.default.error(
                      "[" + t.id + "] ",
                      x.WEB_API_NOT_SUPPORTED
                    ),
                    i && i(x.WEB_API_NOT_SUPPORTED))
                : (r.default.error("[" + t.id + "] ", x.PLAYER_NOT_FOUND),
                  i && i(x.PLAYER_NOT_FOUND));
            }),
            (t.destroy = function() {
              r.default.debug(
                "destroy "
          ...
          t.mediaElemExists = function(e) {
            for (
              var t = e, n = 0;
              n < Object(a.getParameter)("MEDIA_ELEMENT_EXISTS_DEPTH") && t;
              n++
            )
              t = t.parentNode;
            return !!t;
              ...
              (t.incomingMessage = a),
                "new" === t.state
                  ...
                  ? "ANSWER" === a.messageType
                    ? (((n = { sdp: a.sdp, type: "answer" }).sdp = i(n.sdp)),
                      (n.sdp = o(n.sdp)),
                      t.peerConnection
                        .setRemoteDescription(new RTCSessionDescription(n))
                        .catch(function(e) {}),
                ...
                Object.keys(n).forEach(function(i) {
                  ...
                  t.isSubscriber &&
                    ...
                    e({
                      ...
                      frameDropped:
                        parseInt(a.googDecodingPLC) +
                        parseInt(a.googDecodingPLCCNG) +
                        "",
            ...
            (t._getStats = function(e) {
              t.peerConnection.getStats(function(n) {
                ...
                Object.keys(n).forEach(function(e) {
                  var t = n[e];
                  a.push(t),
                    ("ssrc" !== t.type && "VideoBwe" !== t.type) ||
                      ((r = t.timestamp), i.push(t));
                }),
                  i.push({
                    id: "time",
                    startTime: t.connectedTime,
        ...
        ee = function(e, t, n) {
          ...
          var a = 0,
            ...
            d = function(e) {
              if ((a++, c))
                if (c === e)
                  r.default.debug("Using Video Source/ Audio Source");
                else {
      ...
      var Ee = function(e) {
          ...
          t ||
            ((e = Object(a.getParameter)("DEFAULT_PROFILE")),
            (t = a.SUPPORT_RESOLUTION_LIST[e]));
          var n = {
            profileName: e,
        ...
        Te = function(e) {
          var t =
            a.AUDIO_PROFILE_SETTINGS[e] || a.AUDIO_PROFILE_SETTINGS.default;
          return {
            highQuality: t[0],
            stereo: t[1],
            speech: t[2],
      ...
      var Re = function(e) {
          ...
          function n() {
            ...
            t.getVideoTrack() === this
              ? (r.default.debug("Video Track Ended"),
                (e.type = "videoTrackEnded"),
                (e.track = this))
              : t.getAudioTrack() === this
              ? (r.default.debug("Audio Track Ended"),
          ...
          return (
              ...
              (e.audioMixing = {
                ...
                (e.loadAudioBuffer = function(t, n, i) {
                  ...
                  c.open("GET", n, !0),
                    ...
                    (c.onload = function() {
                      if (c.status > 400)
                        s("".concat(c.status, " ").concat(c.statusText));
                      else {
                        var n = c.response;
                ...
                (e._isSoundExists = function(t) {
                  return (
                    ...
                    (r.default.error("SoundId not exists. #".concat(t.soundId)),
                    !1)
                  );
                }),
                ...
                (e._resumeOneEffect = function(t, n) {
                  ...
                  if (i.state === e.audioMixing.states.PAUSED) {
                    ...
                    if (!o) {
                      ...
                      return (
                        n(s),
                        void r.default.error("[".concat(e.streamId, "] "), s)
                      );
                    }
                    (i.source = o),
                      (i.resumeAt = Date.now()),
                ...
                (e._setOneEffectPosition = function(t, n, i) {
                  ...
                  if (a.state === e.audioMixing.states.BUSY) {
                    ...
                    if (!s) {
                      ...
                      return (
                        i && i(c),
                        void r.default.error("[".concat(e.streamId, "] "), c)
                      );
                    }
                    (a.source = s),
                      (a.startAt = Date.now()),
                ...
                (e.startAudioMixing = function(t, n) {
                  ...
                  ce(
                    ...
                    "filePath",
                    1,
                    Object(a.getParameter)("FILEPATH_LENMAX"),
                    !1
                  ),
                    de(u, "playTime", 0, 1e8),
                    !_e(c) && de(c, "cycle"),
            ...
            (t.checkDualStreamEnabled = function() {
              if (
                Object(a.getParameter)("DUALSTREAM_OPERATION_CHECK") &&
                t.isDualStream
              ) {
                return (
                  r.default.error(
            ...
            (t.init = function(i, a) {
              ...
              if (!0 !== t.local)
                return s({ type: "warning", msg: "STREAM_NOT_LOCAL" });
              var d = Math.random()
                .toString()
                .slice(3);
              (this._streamInitID = d),
                t.videoSource
                  ...
                  : t.video &&
                    (t.videoName =
                      ie.searchDeviceNameById(e.cameraId) || "default"),
                t.audioSource
                  ? (t.audioName = "audioSource")
                  : t.audio &&
                    (t.audioName =
                      ie.searchDeviceNameById(e.microphoneId) || "default"),
              ...
              try {
                if (
                  ...
                  s({ type: "warning", msg: "STREAM_HAS_NO_MEDIA_ATTRIBUTES" });
              } catch (e) {
                ...
                t.on("player-status-change", function e(n) {
                  if (((s[n.mediaType] = n), s.audio && s.video))
                    if (
                      ...
                      "aborted" === s.video.status &&
                      "aborted" === s.audio.status
                        ? a({
                            status: "aborted",
                            reason: "stop",
                            video: s.video,
            ...
            (t.getAudioLevel = function() {
              ...
              if (t.stream) {
                if (0 !== t.stream.getAudioTracks().length)
                  return (
                    (t.audioLevelHelper = new te.a(t.stream)),
            ...
            (t.switchDevice = function(e, n, i, a) {
              ...
              var c = function() {
                ...
                d = function(e) {
                  (t.inSwitchDevice = !1),
                    r.default.error("[".concat(t.streamId, "] "), e),
                    s(e);
                };
            ...
            (t.creatConnection = function() {
              ...
              (t.connection.onopen = function(e) {
                r.default.debug(
                  ...
                  t.dispatchEvent(l({ type: "onopen", event: e, socket: t }));
              }),
                  ...
                  t.needReconnect
                    ? t.isTimeout || t.isInit
                      ? (r.default.debug(
                        ...
                        t.connectNext())
                      : t.dispatchEvent(l({ type: "disconnect", event: n }))
                    : (r.default.debug(
          ...
          (i = i.map(function(e) {
            ...
            !(function(e, t, n) {
              ...
              o ||
                (e
                  ? (r.push(e),
                    r.length >= i.length && t && t("ALL_REQUEST_FAILED"))
                  : ((o = !0), t && t(null, n)));
            });
          });
        },
            ...
            Object(Le.c)(
              ...
              function(c) {
                ...
                if (
                  ...
                  d.addresses.forEach(function(e) {
                    ...
                    e.ip && e.port
                      ? (e.ip.match(/^[\.\:\d]+$/)
                        ...
                        f.push(t))
                      : r.default.error(
                          "[" + s.clientId + "] Invalid address format ",
                          e
                        );
                  }),
                  !f.length)
                  ...
                  r.default.error(
                    "[" + s.clientId + "] Empty Address response",
                    d
                  );
                  ...
                  (function(e, t, n) {
                    ...
                    function(i) {
                      i
                        ...
                        : Je[l] !== ot.DISCONNECTED &&
                          Je[l] !== ot.DISCONNECTING
                        ? (r.default.debug(
                            "[" +
                              e.clientId +
            ...
            Object(Le.c)(
              ...
              function(e, t) {
                if ("timeout" === e.type) {
                  ...
                  n && n.dispatchEvent({ type: "error", reason: r }),
                    o.b.reqUserAccount(s.sid, {
                      lts: a,
                      success: !1,
                      serverAddress: t,
              ...
              b.makeRequest(
                ...
                function(t, i) {
                  if (
                    ...
                    return n && n(null);
                  r.default.error("set Client role error to " + e + ": " + t),
                    n && n(t);
                }
              );
            }),
                      ...
                      b.makeRequest(
                        ...
                        function(t, n) {
                          ...
                          if (Qe[t] && b.rejoinAttempt < 4) {
                            if (
                              (b._doWithAction(Qe[t], i, s), b.leaveOnConnected)
                            ) {
                              r.default.error(
                                "[".concat(
                                  b.clientId,
                              ...
                              if (n && n.id) {
                                ...
                                setTimeout(function() {
                                  var e =
                                    ...
                                    Date.now() - b.socket.getLastMsgTime();
                                  e >
                                  Object(a.getParameter)("REPORT_STATS_TIMEOUT")
                                    ? r.default.debug(
                      ...
                      function() {
                        if (
                          ...
                          var t =
                            ...
                            Date.now() - b.socket.getLastMsgTime();
                          if (
                            t > Object(a.getParameter)("REPORT_STATS_TIMEOUT")
                          )
                                      ...
                                      ("video" === t.mediaType &&
                                        ...
                                        (d ||
                                          ...
                                          (e.firstFrameTime =
                                            new Date().getTime() -
                                            e.subscribeLTS),
                                          o.b.firstRemoteFrame(b.joinInfo.sid, {
            ...
            for (var e in b.remoteStreams)
              if (b.remoteStreams.hasOwnProperty(e)) {
                var t = b.remoteStreams[e],
                  n = u({ type: "stream-removed", uid: t.getId(), stream: t });
                b.dispatchEvent(n);
              }
                ...
                (c = e.gatewayAddr),
                    ...
                    if (
                      ...
                      if (
                        ...
                        var i,
                          o =
                            ((i = b.attemps),
                            1e3 * Math.min(30, Math.pow(2, i) - 1));
                        if (
                          (r.default.error(
                            "["
                        ...
                        setTimeout(function() {
                          b.attemps++,
                            ...
                            Date.now() - b.inChannelInfo.joinAt >
                              ...
                              ? (r.default.debug("Recovering to renew ticket"),
                                R())
                              : C();
                        }, o);
                      }
                  ...
                  b.socket.on("on_publish_stream", function(e) {
                    var t = b.localStreams[e.uid],
                      n = d({ type: "streamPublished", stream: t });
                    b.dispatchEvent(n);
                  }),
                  b.socket.on("mute_audio", function(e) {
                    ...
                    var t = u({ type: "mute-audio", uid: e.uid }),
                  ...
                  b.socket.on("unmute_audio", function(e) {
                    ...
                    var t = u({ type: "unmute-audio", uid: e.uid }),
                      n = b.remoteStreams[e.uid];
                    n
                      ? ((n.peerMuteAudio = !1),
                        n.pc && b._adjustPCMuteStatus(n),
                  ...
                  b.socket.on("mute_video", function(e) {
                    ...
                    var t = u({ type: "mute-video", uid: e.uid }),
                      n = b.remoteStreams[e.uid];
                    n
                      ? ((n.peerMuteVideo = !0),
                        n.pc && b._adjustPCMuteStatus(n),
                  ...
                  b.socket.on("unmute_video", function(e) {
                    ...
                    var t = u({ type: "unmute-video", uid: e.uid }),
                      n = b.remoteStreams[e.uid];
                    n
                      ? ((n.peerMuteVideo = !1),
                        n.pc && b._adjustPCMuteStatus(n),
                  ...
                  b.socket.on("on_p2p_lost", function(e) {
                    ...
                    (t = b.localStreams[e.uid] || b.remoteStreams[e.uid])
                      ...
                      (t = b.p2ps.get(e.p2pid)) &&
                        ...
                        t.local
                          ? b.dispatchEvent(
                              u({ type: "pubP2PLost", stream: t, attr: n })
                            )
                          : b.remoteStreams[t.getId()] &&
                            b.dispatchEvent(
                              u({ type: "subP2PLost", stream: t, attr: n })
                            ));
                  }),
                  b.socket.on("on_token_privilege_will_expire", function(e) {
                    r.default.debug(
                      ...
                      b.dispatchEvent(
                        u({ type: "onTokenPrivilegeWillExpire" })
                      );
                  }),
                  b.socket.on("on_token_privilege_did_expire", function() {
                    r.default.warning(
                      ...
                      b.closeGateway(),
                      b.dispatchEvent(u({ type: "onTokenPrivilegeDidExpire" }));
                  }),
                      ...
                      switch ((e.prev = e.next)) {
                        case 0:
                          ...
                          return (
                            ...
                            null,
                            c.connection &&
                              (c.connection.close(), (c.connection = null)),
                            (c.status = ft),
        ...
        Nt = function(e) {
          ...
          return (
            ...
            (t.setClientRole = function(n, i) {
              ...
              if (
                (oe(n, "setClientRole", ["host", "audience"]), "rtc" === t.mode)
              ) {
                var s = "RTC mode can not use setClientRole";
                return (
                  r.default.warning("[".concat(t.clientId, "] ").concat(s)),
                  a && a(s)
                );
              }
            ...
            (t.getGatewayInfo = function(e) {
              if (t.gatewayClient.state !== ot.CONNECTED) {
                ...
                return (
                  r.default.error("[".concat(t.clientId, "] ").concat(n)),
                  void e(n)
                );
              }
            ...
            (t.renewToken = function(n, i, a) {
              var s = o.b.reportApiInvoke(e.sessionId, {
                callback: function(e, t) {
                  if (e)
                    return (
                      r.default.error("Failed to renew token ".concat(e), t),
                      a && a(e)
                    );
                  i && i(t);
                },
            ...
            (t.init = function(n, i, a) {
              ...
              ce(n),
                Object(f.isChromeKernel)() &&
                Object(f.getChromeKernelVersion)() <= 48
                  ? a
                    ? s(x.BAD_ENVIRONMENT)
                    : Object(te.e)()
                  : (r.default.info(
                        ...
                        function(o) {
                          ...
                          if (
                            ...
                            if (
                              ...
                              u =
                                a.SUPPORT_RESOLUTION_LIST[t.highStream.profile];
                              (c.width = u[0]), (c.height = u[1]);
                            }
                            s.setVideoProfileCustomPlus(c);
                          } else
                            s.setVideoProfileCustom(st(t.highStream.profile));
                          s.init(function() {
            ...
            (t._unpublishLowStream = function(e, n) {
              if (0 !== t.lowStreamState)
                return n && n(x.LOW_STREAM_NOT_YET_PUBLISHED);
              t.lowStream &&
            ...
            (t.join = function(n, i, a, s, c) {
              ...
              if (a && !Object(te.c)(a) && !le(a, 1, 255))
                return (
                  r.default.error(
                    "Invalid UID ".concat(a, " ").concat(re()(a))
                  ),
                  r.default.warning(
                    "[".concat(
                      t.clientId,
              ...
              if (
                ("string" == typeof a &&
                  ((l.stringUid = a),
                  t.uintUid
                    ? ((l.uid = t.uintUid), delete t.uintUid)
                    : (l.uid = 0)),
                t.aespassword &&
                  "none" !== t.aesmode &&
                  S()(l, { aespassword: t.aespassword, aesmode: t.aesmode }),
            ...
            (t.subscribe = function(n, i, a) {
              ...
              if (!_e(i)) {
                if (Object(f.isSafari)() && (!i.video || !i.audio)) {
                  ...
                  return (
                    r.default.error("[".concat(t.clientId, "] "), d), void s(d)
                  );
                }
                if (
              ...
              return (
                ...
                (t.getLocalAudioStats = function(e) {
                  ...
                  for (var i in t.localStats) {
                    ...
                    o &&
                      o.isPlaying() &&
                      ne(a, "MuteState", o.userMuteAudio ? "1" : "0"),
                      (n[i] = a);
                  }
                  e && e(n);
                }),
                ...
                (t.getStatsTimer = setInterval(function() {
                  ...
                  var a = {};
                  if (
                    (Object.keys(t.gatewayClient.localStreams).forEach(function(
                      e
                    ) {
                    ...
                    (t.localStats = a),
                    (t.session.HTTPSendBytesDelta =
                      Object(Le.b)() - t.session.HTTPSendBytes),
                    (t.session.HTTPSendBytes = Object(Le.b)()),
                    (t.session.HTTPRecvBytesDelta =
                      Object(Le.a)() - t.session.HTTPRecvBytes),
            ...
            (function(e, t) {
              ...
              (e.liveStreaming = s()),
                ...
                e.gatewayClient.addEventListener("stream-unpublished", function(
                  t
                ) {
                ...
                e.gatewayClient.addEventListener("stream-published", function(
                  t
                ) {
                        ...
                        function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              ...
                              case 13:
                                if (
                                  !e.liveStreaming.pushStates.hasOwnProperty(o)
                                ) {
                                  t.next = 35;
                                  break;
                                }
                ...
                (e.setLiveTranscoding = function(n, i) {
                  ...
                  if (
                    ...
                    I.map(function(e, t) {
                      ...
                      if (
                        (_e(e.x) ||
                          de(e.x, "transcodingUser[".concat(t, "].x"), 0, 1e4),
                        _e(e.y) ||
                          de(e.y, "transcodingUser[".concat(t, "].y"), 0, 1e4),
                        _e(e.width) ||
                          de(
                            e.width,
                        ...
                        !(
                          _e(e.alpha) ||
                          (Se(e.alpha) && e.alpha <= 1 && e.alpha >= 0)
                        ))
                      )
                        throw new Error(
                  ...
                  if (
                    ...
                    n.userConfigs.forEach(function(t) {
                      _.push(
                        Xe(e.joinInfo, e.gatewayClient, t.uid).then(function(
                          e
                        ) {
                          t.uid = e.uid;
                        })
                ...
                (e.addInjectStreamUrl = function(i, a) {
                  ce(i, "url", 1, 255),
                    ...
                    !_e(a && a.videoGop) &&
                      de(a.videoGop, "config.videoGop", 1, 1e4),
                    !_e(a && a.videoFramerate) &&
                      de(a.videoFramerate, "config.videoFramerate", 1, 1e4),
                    !_e(a && a.videoBitrate) &&
                      de(a.videoBitrate, "config.videoBitrate", 1, 1e4),
                    !_e(a && a.audioSampleRate) &&
                      oe(a.audioSampleRate, "config.audioSampleRate", [
                        32e3,
                        44100,
                        48e3
                      ]),
                    !_e(a && a.audioBitrate) &&
                      de(a.audioBitrate, "config.audioBitrate", 1, 1e4),
                    !_e(a && a.audioChannels) &&
                      de(a.audioChannels, "config.audioChannels", 1, 2);
              ...
              t.joinInfo.stringUid && !t.joinInfo.uid
                ? (t.userAccountReq &&
                  ...
                  t.userAccountReq
                    ...
                    .catch(function(e) {
                      r.default.error("getUserAccount rejected", e),
                        t.onFailure(e);
                    }))
                : ze(t.joinInfo, n, t.onFailure);
            }),
            ...
            t.gatewayClient.on("streamPublished", function(e) {
              t.hasPublished ||
                ((t.hasPublished = !0),
                t.gatewayClient.dispatchEvent(
                  d({ type: "stream-published", stream: e.stream })
                ));
            }),
            ...
            t.gatewayClient.on("streamTypeChange", function(n) {
              ...
              t.gatewayClient.dispatchEvent(i),
                o.b.reportApiInvoke(e.sessionId, { name: "streamTypeChange" })(
                  null,
                  JSON.stringify(n)
                );
            }),
      ...
      t.default = {
        ...
        createStream: function(e) {
          ...
          if (
            ...
            _e(d) ||
              oe(d, "facingMode", ["user", "environment", "left", "right"]),
        ...
        checkSystemRequirements: function() {
          ...
          r.default.debug(f.getBrowserInfo(), "isAPISupport:" + a),
            ...
            f.isEdge() && (s = !0),
            (f.isWeChatBrowser() || f.isQQBrowser()) &&
              "iOS" !== f.getBrowserOS() &&
              (s = !0),
